                ...
                <li class="sidebar-item ">
                  <a class="sidebar-link has-arrow" href="<?= base_url(); ?>/public/dist/main/index3.html" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                     ...
                     <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('editreturn/'.base64_encode(base64_encode(base64_encode($alldata['return_id'])))); ?>">
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Return Info</h4>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('updatereturn'); ?>">
                  <div class="card-body">
                    <h4 class="card-title">Assets Return Info</h4>
<?php 
...
if(isset($session->success)):?>
         ...
         <?php endif; ?>            
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="hidden" name="return_id" value="<?= $alldata['return_id'];?>" >
                          <select name="assets_grn_no" class="form-control" id="check">
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="assets_name" id="title2"  placeholder="Enter the Asset Name" />
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="email4" class="form-label">Returned By</label>
                            <input type="text" class="form-control" name="returned_by"  id="email4" value="<?= $alldata['returned_by'];?>"  placeholder="Enter the Returned By" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="conno2" class="form-label">Approved By</label>
                            <input type="text" class="form-control" name="approved_by" id="conno2" value="<?= $alldata['approved_by'];?>"  placeholder="Enter the Approved By" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Return Qty</label>
                                <input type="text" class="form-control" name="return_qty" id="conno2" value="<?= $alldata['return_qty'];?>"  placeholder="Enter the Return Qty" />
                          </div>
                        </div>
                      </div>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-3">List of Child Part</h4>
                   <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" onclick="toggleSelectAll(this)" />
                        <h6>
                          Select All
                        </h6>
                      </div>
                 ...
                 <?php 
                 $decode=json_decode($alldata['return_childpart']);
                 if($decode!=''){
                 foreach($decode as $onebyone){?>
                    <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="return_childpart[]" value="<?= $onebyone ?>" id="checkbox" />
                 <label class="form-check-label" for="list1"><?= $onebyone ?></label>
                 </div>
                 <?php } }?>
                  </ul>
                </div>
                   ...
                   <?php 
                          $base=base64_encode(base64_encode(base64_encode($alldata['return_id'])));
                      ?>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer  align-items-center">
                    <div class="d-flex gap-6 m-0">
                       <a href="<?= base_url('deletereturn/'.$base); ?>"  id="btn-add" class="btn btn-danger justify-content-center">Yes</a>
...
<script>
 $(document).ready(function () {
      ...
      $('#check').change(function () {
       ...
       // alert (custId);
        $.ajax({
          url: 'http://freelance.neuralarc.com/viyoma/childpart/'+custId,
          type: 'get',
         // data: { custId: custId },
          success: function (response) {
           ...
           for (var i in dd) {
                 ...
                 var ipnews = '<div class="form-check">';
                  ipnews +='<input class="form-check-input" type="checkbox" name="return_childpart[]" value="'+dd[i]+'" id="checkbox" />';
                 ipnews +='<label class="form-check-label" for="list1">'+dd[i]+'</label>';
                 ipnews +='</div>';
                 
                 
                 $('#itemsList').append(ipnews);
