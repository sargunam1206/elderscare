            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Wallets</h4>
...
<div class="col-12" id="part_number">
  <div class="mb-3">
    ...
    <?php $single_count=count($wallet_guest);
    ?>
    <input type="hidden" name="type_user" value="<?= !empty($room and $single_count==1 ) ? 'single' : 'multiple' ?>">
    <div class="dropdown">
      <input type="text" 
             ...
             aria-expanded="false"   value="<?= !empty($room and $single_count==1 ) ? $room[0]['room_no'] : '' ?>"/>
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" 
             ...
             autocomplete="off"
             data-bs-toggle="dropdown" 
             aria-expanded="false"   value="<?= !empty($room and $single_count==1 ) ? $room[0]['first_name'] : '' ?>"/>
   ...
   <div class="col-12">
      <div class="mb-3">
        ...
        <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100" name="balance" id="balance"  value="<?= !empty($room and $single_count==1 ) ? $room[0]['balance'] : '' ?>"  autocomplete="off" readonly />
    ...
    document.querySelectorAll("#relationLists .dropdown-item").forEach(function(item) {
        item.addEventListener("click", function() {
            ...
            // Fetch categories from API
               fetch(`/viyoma/roomguest/${selectedService}`)
    ...
    document.getElementById("categoryList").addEventListener("click", function(e) {
        ...
        if (target) {
           ...
           //console.log(selectedCategory);
            // Fetch modes
            fetch(`/viyoma/guest_wallet/${selectedCategory}`)
                .then(response => response.json())
