          ...
          <div class="sidebarmenu">
            ...
            <nav class="sidebar-nav" id="menu-right-mini-0" data-simplebar>
              <ul class="sidebar-menu" id="sidebarnav">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link has-arrow" href="" id="get-url" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                      ...
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url(); ?>/public/dist/main/viewassets.html">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link" href="<?= base_url(); ?>/public/dist/main/index2.html" aria-expanded="false">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link" href="<?= base_url(); ?>/public/dist/main/index3.html" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                      <a class="sidebar-link" href="<?= base_url(); ?>/public/dist/main/eco-shop.html">
                         <span class="hide-menu">Purchase </span>
                      </a>
                    </li>
                    <li class="sidebar-item">
                      <a class="sidebar-link" href="<?= base_url(); ?>/public/dist/main/eco-shop-detail.html">
                         <span class="hide-menu">Depreciation </span>
                      </a>
                    </li>
                    <li class="sidebar-item">
                      <a class="sidebar-link" href="<?= base_url(); ?>/public/dist/main/eco-product-list.html">
