        ...
        <div class="col-md-12">
          <div class="card p-4 h-100 d-flex flex-column">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <h5><i class="bi bi-calendar-event me-2 text-success"></i>Scheduled Activities</h5>
              <div>
            ...
            <div class="table-responsive">
              <table id="activitiesTable" class="table table-striped w-100 table-bordered display text-nowrap align-middle">
                <thead>
                  <tr>
