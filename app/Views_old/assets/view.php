...
if(isset($session->success)):?>
 ...
 <?php endif; ?>                   
                ...
                ini_set('display_startup_errors', '1');
                error_reporting(E_ALL);?>
            <form method="post"  action="<?= base_url('viewassets'); ?>">
                  <div class="row"> 
                          ...
                          <div class="col-md-3">
                          <select name="assets_type" class="form-control" >
                  ...
                  <form method="post" action="<?= base_url('downloadassets'); ?>"
                  ...
                  <table id="form_inputs"  class="table table-striped w-100 table-bordered display text-nowrap align-middle">
                    ...
                    <tbody >
                      ...
                      <?php foreach($alldata as $data){ 
                          $base=base64_encode(base64_encode(base64_encode($data['assets_id'])));
                      ?>
                      <tr>
                        <td ><?= $data['assets_grn_no']; ?></td>
                        <td><?= $data['assets_name']; ?></td>
                        <td><?= $data['assets_brand']; ?></td>
                        <td><?= $data['assets_vendor']; ?></td>
                                    <td><img src="<?php 
                            if($data['asset_image']!= '') { 
                                echo base_url() .'public/'. $data['asset_image']; 
                            } else { 
                                echo base_url(); 
                            }  
                        ?>" height="100px" width="100px"><br> <a href="<?php if($data['asset_image']!=''){ echo base_url().'public/'.$data['asset_image']; }  ?>"  target="_blank">Image Link</a>   </td></td>
                        <td><?= $data['assets_customer_name']; ?></td>
                        <td><?= $data['assets_party_name']; ?></td>
                        <td><?= $data['assets_qty_avl']; ?></td>
                        <td><?= $data['assets_rec_level']; ?></td>
                        <td><?= $data['assets_location']; ?></td>
                        <td><?= $data['assets_room']; ?></td>
                        <?php if($assets_type=='DelAssets'){?>
                        <td><?= $data['assets_deleted_on']; ?></td>
                        <?php }else{ ?><td><?= $data['assets_created_on']; ?></td> <?php }?>
                        <td> <a href="<?= base_url('editassets/'.$base); ?>" class="btn btn-info">
                          Update
                          </a>
                          </td>
                      </tr>
