                ...
                <li class="sidebar-item ">
                  <a class="sidebar-link has-arrow" href="" id="get-url" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                      ...
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('editassets/'.base64_encode(base64_encode(base64_encode($alldata['assets_id'])))); ?>">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('updateassets'); ?>" enctype="multipart/form-data">
                  <div class="card-body">
...
<?php endif; ?>                    
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="hidden"  value="<?= $alldata['assets_id']?>" class="form-control" name="assets_id" placeholder="Enter the GRN No" />
                          <input type="text"  value="<?= $alldata['assets_grn_no']?>" class="form-control" name="assets_grn_no" id="fname3" placeholder="Enter the GRN No" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="title2" class="form-label">Asset Name</label>
                          <input type="text" class="form-control" value="<?= $alldata['assets_name']?>" name="assets_name" id="title2" placeholder="Enter the Asset Name" />
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="comname1" class="form-label">Asset Brand</label>
                          <input type="text" class="form-control" value="<?= $alldata['assets_brand']?>" name="assets_brand" id="comname1" placeholder="Enter the Asset Brand" />
                        </div>
                      </div>
                      ...
                      <img src="<?php 
                            if($alldata['asset_image']!= '') { 
                                echo base_url() .'public/'. $alldata['asset_image']; 
                            } else { 
                                echo base_url(); 
                            }  
                        ?>" height="200px" width="300px"><br> <a href="<?php if($alldata['asset_image']!=''){ echo base_url().'public/'.$alldata['asset_image']; }  ?>"  target="_blank">Image Link</a> 
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="email4" class="form-label">Vendor Name</label>
                            <input type="text" class="form-control" value="<?= $alldata['assets_vendor']?>" name="assets_vendor"  id="email4" placeholder="Enter the Vendor Name" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<?= $alldata['assets_customer_name']?>" name="assets_customer_name" id="conno2" placeholder="Enter the Customer Name" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= $alldata['assets_party_name']?>" name="assets_party_name" id="conno2" placeholder="Enter the Party Name" />
                          </div>
                        </div>
                      </div>
                        <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assets_qty_avl" value="<?= $alldata['assets_qty_avl']?>" id="conno2" placeholder="Enter the Qty Available" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Recorder Level</label>
                                <input type="text" class="form-control" name="assets_rec_level" value="<?= $alldata['assets_rec_level']?>" id="conno2" placeholder="Enter the Recorder Level" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assets_location" value="<?= $alldata['assets_location']?>" id="conno2" placeholder="Enter the Location" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assets_room" value="<?= $alldata['assets_room']?>" id="conno2" placeholder="Enter the Room" />
                          </div>
                        </div>
                      </div>
                  ...
                  <?php 
                   $base=base64_encode(base64_encode(base64_encode($alldata['assets_id'])));
                  ?>
                  <div class="p-3 border-top">
                    <div class="d-flex flex-wrap gap-6 align-items-center">
                      <div>
                        <div >
                          <button type="submit" name="update" value="submit" class="btn btn-primary">
                            Update
                          </button>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer  align-items-center">
                    <div class="d-flex gap-6 m-0">
                      <a href="<?= base_url('deleteassets/'.$base); ?>"  id="btn-add" class="btn btn-danger justify-content-center">Yes</a>
