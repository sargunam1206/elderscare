            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Rooms</h4>
    ...
    <div class="modal-content">
     ...
     <div class="col-12">
      <div class="mb-3">
        ...
        <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100" name="room_no" id="room_no" placeholder="Enter Room No "  autocomplete="off" />
...
<div class="col-12" id="part_number" >
  ...
  <div class="dropdown">
    <input type="text" class="form-control dropdown-toggle w-100" name="room_type" id="roomTypeInput"
      placeholder="Select Room Type" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly />
...
<div class="col-12" id="part_number" >
  ...
  <div class="dropdown">
    <input type="text" class="form-control dropdown-toggle w-100" name="room_status" id="roomInput"
      placeholder="Select Room Status" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly />
