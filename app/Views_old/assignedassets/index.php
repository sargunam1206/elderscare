        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Add AssignedAssets</h4>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('assignedassets'); ?>">
                  <div class="card-body">
                    <h4 class="card-title">Add AssignedAssets</h4>
<?php 
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="title2" class="form-label">Asset Name</label>
                           <select name="purchase_vendor" class="form-control" id="assets_name">
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="assets_part_name"  placeholder="Enter the Part Name" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="assets_customer_name" id="assets_customer_name" placeholder="Enter the Customer Name" />
                          </div>
                        </div>
                      </div>
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="assets_qty_avl" id="assets_qty_avl" placeholder="Enter the Qty Available" />
                          </div>
                        </div>
                      </div>
                          <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="assigned_assets_employee" id="assigned_assets_employee" placeholder="Enter the Customer Name" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assigned_assets_qty_assigned" id="assigned_assets_qty_assigned" placeholder="Enter the Quantity" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="assets_part_name" name="assigned_assets_retureddate" placeholder="Enter the Part Name" />
                          </div>
                        </div>
                      </div>
										...
										<thead >
											...
											<tbody >
												<tr>
													...
													<td>
                                                      <input  type="text" name="assigned_assets_childpart[]" class="form-control"  placeholder="Enter the Child Part" style="width:60%">
													</td>
...
<script type="text/javascript">
    $(document).ready(function () {
      ...
      $('#assets_grn_no').change(function () {
           
       $('#test').empty();
        var custId =$(this).val();
         
        $.ajax({
          url: 'http://freelance.neuralarc.com/viyoma/assetsdata/'+custId,
          type: 'get',
          data: { custId: custId },
          success: function (response) {
            ...
            $('#assets_part_name').val(dd.assets_party_name);
            $('#assets_customer_name').val(dd.assets_customer_name);
            $('#assets_qty_avl').val(dd.assets_qty_avl);
            $('#assetsvalue_value').val(dd.assetsvalue_value);
