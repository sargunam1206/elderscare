    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          ...
          <div class="datatables">
                ...
                <form method="post" action="<?= base_url('viewpurchase1'); ?>">
                  ...
                  <h4 class="card-title">View Purchase</h4>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <h4 class="card-title mb-0">View Purchase</h4>
                      <a href="<?= base_url('purchase1'); ?>" class="btn btn-primary">+ Add Purchase</a>
                    </div>
            ...
            <button type="submit" name="submit" value="excel" formaction="<?= base_url('downloadexcel'); ?>" class="btn btn-primary">Excel</button>-->
                          <!-- Excel Button -->
                        </div>
                      </div>
                    </form>
                    ...
                    <div class="table-responsive mt-3">
                      <table class="table table-borderless w-100">
                        ...
                        <tr>
                          <td class="p-1">
                            <div class="dropdown">
                              <button class="btn btn-info dropdown-toggle w-100" type="button" id="supplierDropdown"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                Dealer Name
                              </button>
                              <ul class="dropdown-menu p-3" aria-labelledby="supplierDropdown"
                                style="max-height: 200px; overflow-y: auto;">
                                <input type="text" class="form-control mb-2" id="supplierSearch" placeholder="Search"
                                  autocomplete="off" />
                          ...
                          <td class="p-1">
                            ...
                            <div class="dropdown ">
                              ...
                              <ul class="dropdown-menu w-100 p-3" aria-labelledby="assetTypeDropdown"
                                style="max-height: 200px; overflow-y: auto; width: 150%; padding: 0;">
                                <li>
                                  <input type="text" class="form-control mb-2" id="assetTypeSearch" placeholder="Search"
                                    autocomplete="off" />
                                </li>
                                <li>
                                  <div class="form-check">
                                ...
                                <li>
                                  <div class="mt-2">
                                    <button type="submit" class="btn btn-light btn-sm w-100"
                                      id="applyAssetFilters">Apply Filters</button>
                                  </div>
                                </li>
                              </ul>
                            </div>
                          ...
                          <td class="p-1">
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu p-3" aria-labelledby="assetMakeDropdown"
                                style="max-height: 200px; overflow-y: auto;">
                                <input type="text" class="form-control mb-2" id="assetMakeSearch" placeholder="Search"
                                  autocomplete="off" />
                                <div class="form-check">
                          ...
                          <td class="p-1">
                            <div class="dropdown">
                              <button class="btn btn-info dropdown-toggle w-100" type="button"
                                id="purchaseStatusDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                Purchase Status
                              </button>
                              <ul class="dropdown-menu p-3" aria-labelledby="purchaseStatusDropdown"
                                style="max-height: 200px; overflow-y: auto;">
                                <div class="form-check">
                                ...
                                <div>
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="purchase_status_filters[]"
                                      value="Order Placed" id="statusOrderPlaced" />
                                    <label class="form-check-label" for="statusOrderPlaced">Order Placed</label>
                                  </div>
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="purchase_status_filters[]"
                                      value="Assets Received" id="statusAssetsReceived" />
                                    <label class="form-check-label" for="statusAssetsReceived">Assets Received</label>
                                  </div>
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="purchase_status_filters[]"
                                      value="Assets Pending" id="statusAssetsPending" />
                          ...
                          <td class="p-1">
                            <div class="dropdown">
                              <button class="btn btn-info dropdown-toggle w-100" type="button"
                                id="purchaseReasonDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                Purpose
                              </button>
                              <ul class="dropdown-menu p-3" aria-labelledby="purchaseReasonDropdown"
                                style="max-height: 200px; overflow-y: auto;">
                                <input type="text" class="form-control mb-2 w-100" id="purchaseReasonSearch"
      ...
      <a href="javascript:void(0)" id="btn-delete-trigger" class="btn btn-danger w-100">
        <i class="fas fa-trash-alt"></i> Delete
                          ...
                          <td class="p-1">
                            <button type="submit" name="submit" value="download" formtarget="_blank"
                              formaction="<?= base_url('downloadpurchase'); ?>" class="btn btn-primary me-3" title="Download Pdf">
                             <i class="bi bi-file-earmark-pdf fs-5"></i>
                            </button>
                            
                            <button type="submit" name="submit" value="excel"
                              formaction="<?= base_url('downloadexcel'); ?>" class="btn btn-primary" title="Download Excel">
                      ...
                      <table id="form_inputs"
                        ...
                        <td><?= $data['purchase_reason']; ?></td>-->
                              ...
                              <td> <a href="<?= base_url('editpurchase1/' . $base); ?>" class="btn" style="color:blue">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="deletePurchaseModal<?= $data['purchase_id']; ?>"
                                  tabindex="-1">
                                  <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer justify-content-end">
                                        <a href="<?= base_url('deletepurchase1/' . $base); ?>"
