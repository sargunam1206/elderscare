                ...
                <li class="sidebar-item ">
                  <a class="sidebar-link has-arrow" href="<?= base_url('assetsvalue'); ?>" aria-expanded="false">
                   ...
                   <ul aria-expanded="false" class="collapse first-level">
                      ...
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('editassetsvalue/'.base64_encode(base64_encode(base64_encode($alldata['assetsvalue_id'])))); ?>">
                          <span class="icon-small"></span>Edit Assetsvalue
                        </a>
                      </li>
                    </ul>
                </li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('updateassetsvalue'); ?>">
                  <div class="card-body">
                    <h4 class="card-title">Edit Assets Value</h4>
<?php 
...
<?php endif; ?>                    
                    ...
                    <div class="row">
                       <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="hidden" value="<?=$alldata['assetsvalue_id'];?>" name="assetsvalue_id">
                          <select name="assets_grn_no" class="form-control">
                              <?php if(isset($alldata['assets_grn_no'])){?><option value="<?= $alldata['assets_grn_no']?>" selected><?= $alldata['assets_grn_no']?></option><?php } ?>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="assetsvalue_value" value="<?= $alldata['assetsvalue_value']?>" id="title2" placeholder="Enter the Asset Value" />
                        </div>
                      </div>
                 ...
                 <?php
                 $base=base64_encode(base64_encode(base64_encode($alldata['assetsvalue_id']))); 
                 ?>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer  align-items-center">
                    <div class="d-flex gap-6 m-0">
                      <a href="<?= base_url('deleteassetsvalue/'.$base); ?>"  id="btn-add" class="btn btn-danger justify-content-center">Yes</a>
