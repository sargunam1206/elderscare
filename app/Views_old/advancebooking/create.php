        ...
        <div class="form-section card-border p-4 mb-4">
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-4">
              ...
              <div class="invalid-feedback">Please provide the enquiry person's name.</div>
            </div>
            <div class="mb-3 col-md-4">
              <label for="relationInput" class="form-label required">Relation</label>
              <div class="dropdown" id="relationDropdown">
                <input type="text" class="form-control dropdown-toggle w-100 dropdown-input" name="relation" id="relationInput"
          ...
          <div class="row">
            <div class="col-xl-6">
              ...
              <div class="row g-2 mb-2 align-items-end">
                ...
                <div class="col-md-2">
                  <select class="form-select" placeholder="select" id="guest2_title" name="guest2_title" required>
                    <option value="">Title</option> 
                    <option value="Mr.">Mr.</option>
                    <option value="Mrs.">Mrs.</option>
                    <option value="Miss.">Miss.</option>
              ...
              <div class="mt-4 form-check">
                <input type="checkbox" class="form-check-input" name="scanned_documents_collected"
                  id="scannedDocsCheckbox" required>
                <label class="form-check-label" for="scannedDocsCheckbox">
                  Collected Scanned Documents <span class="validation-message">Required when status is Confirmed</span>
                </label>
                <div class="invalid-feedback">Please confirm that scanned documents have been collected.</div>
              </div>
            </div>
            ...
            <div class="col-xl-6">
              <div class="mt-1">
                ...
                <div class="mb-3">
                  <label class="form-label">Address Proof (Aadhar) <span class="validation-message">Required when status is Confirmed</span></label>
                  <input type="file" name="address_proof_file" class="form-control" id="addressProofInput" required>
                  <div class="invalid-feedback">Please upload an address proof document.</div>
                </div>
