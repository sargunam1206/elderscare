...
<meta http-equiv="refresh" content="900;url=http://viyoma.neuralarc.com/viyoma/logout"  />
  ...
  <title>MatDash Bootstrap Admin</title>
    ...
    .checkbox-item {
      width: calc(33.33% - 12px); /* 3 per row with gap */
...
<!-- Admin Menu -->
<li class="sidebar-item 
    <?php if (strpos($current_url, 'assettype') !== false || 
              strpos($current_url, 'assetmake') !== false || 
              strpos($current_url, 'dealers') !== false || 
              strpos($current_url, 'uom') !== false) echo 'active'; ?>">
    ...
    <ul aria-expanded="true" class="collapse first-level show">
        ...
        <!-- Asset Type -->
        <li class="sidebar-item <?php if (strpos($current_url, 'assettype') !== false) echo 'active'; ?>">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="true">
                <span class="hide-menu">Asset Type</span>
            </a>
            <ul aria-expanded="true" class="collapse second-level <?php if (strpos($current_url, 'assettype') !== false) echo 'show'; ?>">
                <li class="sidebar-item <?php if ($current_url == base_url('assettype')) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('assettype'); ?>">
                        <span class="icon-small"></span>Add Asset Type
                    </a>
                </li>
                <li class="sidebar-item <?php if ($current_url == base_url('viewassettype')) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('viewassettype'); ?>">
                        <span class="icon-small"></span>View Asset Type
                    </a>
                </li>
                              <li class="sidebar-item <?php if (strpos($current_url, 'editassettype') !== false) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('editassettype/'.$assettypes['id']); ?>">
                        <span class="icon-small"></span>Edit Asset Type
                    </a>
                </li>
            </ul>
        </li>
        ...
        <!-- Asset Make -->
        <li class="sidebar-item <?php if (strpos($current_url, 'assetmake') !== false) echo 'active'; ?>">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="true">
                <span class="hide-menu">Asset Make</span>
            </a>
            <ul aria-expanded="true" class="collapse second-level <?php if (strpos($current_url, 'assetmake') !== false) echo 'show'; ?>">
                <li class="sidebar-item <?php if ($current_url == base_url('assetmake')) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('assetmake'); ?>">
                        <span class="icon-small"></span>Add Asset Make
                    </a>
                </li>
                <li class="sidebar-item <?php if ($current_url == base_url('viewassetmake')) echo 'active'; ?>">
        ...
        <!-- Dealer Name -->
        <li class="sidebar-item <?php if (strpos($current_url, 'dealers') !== false) echo 'active'; ?>">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="true">
                <span class="hide-menu">Dealer Name</span>
            </a>
            <ul aria-expanded="true" class="collapse second-level <?php if (strpos($current_url, 'dealers') !== false) echo 'show'; ?>">
                <li class="sidebar-item <?php if ($current_url == base_url('dealers')) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('dealers'); ?>">
                        <span class="icon-small"></span>Add Dealer Name
                    </a>
                </li>
                <li class="sidebar-item <?php if ($current_url == base_url('viewdealers')) echo 'active'; ?>">
        ...
        <!-- UOM -->
        <li class="sidebar-item <?php if (strpos($current_url, 'uom') !== false) echo 'active'; ?>">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="true">
                <span class="hide-menu">UOM</span>
            </a>
            <ul aria-expanded="true" class="collapse second-level <?php if (strpos($current_url, 'uom') !== false) echo 'show'; ?>">
                <li class="sidebar-item <?php if ($current_url == base_url('uom')) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('uom'); ?>">
                        <span class="icon-small"></span>Add UOM
                    </a>
                </li>
                <li class="sidebar-item <?php if ($current_url == base_url('viewuom')) echo 'active'; ?>">
...
-->
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-md-0 card-title">Asset Type</h4>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form method="post" action="<?= base_url('updateassettype/' . $assettypes['id']); ?>" enctype="multipart/form-data">
                        <div class="card-body">
                            <h4 class="card-title">Edit Asset Type</h4>
                            <?php 
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="asset_type" class="form-label">Asset Type</label>
                                            ...
                                            <input 
                                                type="text" class="form-control dropdown-toggle w-100"  name="asset_type" id="assetTypeInput"  placeholder="Enter or Select Asset Type" value="<?= old('asset_type', $assettypes['asset_type']); ?>" data-bs-toggle="dropdown"  aria-expanded="false"  autocomplete="off" 
                                            />
  ...
  <div class="row">
    <div class="col-6">
      <div class="mb-3">
       <input type="checkbox" id="selectAll" onclick="toggleAll(this);"> All<br>
  ...
  <div class="checkbox-container">
      <?php $selected_field1=$assettypes['asset_form_field'];
          $selected_field=json_decode($selected_field1);
      ?>
  <?php 
        
        foreach ($input_field as $label): 
           
  ?>
    <div class="checkbox-item">
      <label>
        <input type="checkbox" class="item" name="fields[]" value="<?= htmlspecialchars($label) ?>" 
        
        <?php  if(is_array($selected_field)): ?>
      <?php  foreach($selected_field as $selected_label): ?>
        <?= $selected_label === $label ? 'checked' : ''  ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer d-flex gap-3">
        ...
        <a href="<?= base_url('deleteassettype/' . $assettypes['id']); ?>" id="btn-confirm-delete" class="btn btn-danger">
          Yes
        </a>
        <!-- Cancel Button -->
