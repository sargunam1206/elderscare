            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Service Modes</h4>
...
<div class="modal fade" id="vertical-center-scroll-modal" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <form method="post"  id="assetForm"  action="<?= base_url('addservicemodes'); ?>" enctype="multipart/form-data">
  ...
  <div class="mb-3">
   ...
   <div class="col-12">
      <div class="mb-3">
        ...
        <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100" name="name" id="name" placeholder="Enter Service Mode "  autocomplete="off" />
      ...
      <div class="mb-3">
        ...
        <div class="dropdown">
                    <input type="number" class="form-control dropdown-toggle w-100" name="price" id="price" placeholder="Enter Price "  autocomplete="off" />
 ...
 <div class="col-12">
      <div class="mb-3">
        ...
        <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100" name="description" id="description" placeholder="Enter Description "  autocomplete="off" />
