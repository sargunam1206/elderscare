                  ...
                  <ul aria-expanded="false" class="collapse first-level">
                    ...
                    <li class="sidebar-item">
                      <a class="sidebar-link"
                        href="<?= base_url('editasset/' . base64_encode(base64_encode(base64_encode($asset['id'])))); ?>">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form method="post" action="<?= base_url('updateasset/' . $asset['id']); ?>"
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="asset_type"
                              id="assetTypeInput" value="<?= old('asset_type', $asset['asset_type']); ?>"
                              placeholder="Enter or Select Asset Type" data-bs-toggle="dropdown" aria-expanded="false"
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="customer_name"
                              id="customerNameInput" value="<?= old('customer_name', $asset['customer_name']); ?>"
                              placeholder="Enter or Select Customer Name" data-bs-toggle="dropdown"
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="asset_make"
                              id="assetMakeInput" value="<?= old('asset_make', $asset['asset_make']); ?>"
                              placeholder="Enter or Select Asset Make" data-bs-toggle="dropdown" aria-expanded="false"
                              autocomplete="off" readonly />
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="purpose"
                              id="purposeInput" value="<?= old('purpose', $asset['purpose'] ?? ''); ?>"
                              placeholder="Enter or Select Purpose" data-bs-toggle="dropdown" aria-expanded="false"
                              autocomplete="off" />
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            ...
                            <input type="text" class="form-control w-100" id="uomInput" name="uom"
                              value="<?= old('uom', $asset['uom'] ?? ''); ?>" placeholder="Enter or Select UOM"
                              autocomplete="off" readonly />

                            <!-- Dropdown structure -->
                            <div class="dropdown-menu p-3 w-100" style="max-height: 150px; overflow-y: auto;"
                              id="uomDropdown">
                              <!-- Search box inside the dropdown -->
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="current_stock"
                            value="<?= old('current_stock', $asset['current_stock'] ?? ''); ?>"
                      ...
                      <div class="col-6" id="calibration_id" style="display:none">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="calibration_id"
                            value="<?= old('calibration_id', $asset['calibration_id'] ?? ''); ?>"
                      ...
                      <div class="col-6" id="reorder_level" style="display:none">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="reorder_level" id="reorder_level"
                            value="<?= old('reorder_level', $asset['reorder_level']); ?>"
                      ...
                      <div class="col-6" id="serial_id" style="display:none">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="serial_id"
                            value="<?= old('serial_id', $asset['serial_id'] ?? ''); ?>" placeholder="Enter Serial Id"
                            autocomplete="off" />
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            ...
                            <input type="text" class="form-control w-100" name="dealer_name"
                              ...
                              placeholder="Enter or Select Dealer Name" autocomplete="off" id="dealerNameInput"
                              readonly />
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="location"
                              id="locationInput" value="<?= old('location', $asset['location']); ?>"
                              placeholder="Enter or Select Location" data-bs-toggle="dropdown" aria-expanded="false"
                              autocomplete="off" />
                      ...
                      <div class="col-6" id="asset_image" style="display:none">
                        <div class="mb-3">
                          ...
                          <?php if (!empty($asset['asset_image'])): ?>
                            <img src="<?= base_url($asset['asset_image']); ?>" alt="Asset Image" width="100"
                              id="imageThumbnail" style="cursor: pointer;">
                          <?php endif; ?>
                        </div>
                      </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="room" id="roomInput"
                              value="<?= old('room', $asset['room']); ?>" placeholder="Enter or Select Room"
                      ...
                      <div class="col-6" id="grade" style="display:none">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="grade" id="grade"
                            value="<?= old('grade', $asset['grade'] ?? ''); ?>" placeholder="Enter Grade"
                            autocomplete="off" />
                        </div>
                      </div>
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="GRN" id="grn"
                            value="<?= isset($asset['grn']) ? $asset['grn'] : ''; ?>" readonly />
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="material"
                              id="materialInput" value="<?= old('material', $asset['material']); ?>"
                              placeholder="Enter or Select Material" data-bs-toggle="dropdown" aria-expanded="false"
                              autocomplete="off" />
                        ...
                        <div class="mb-3">
                          ...
                          <div>
                            <button type="button" class="btn bg-danger-subtle text-danger ms-6 px-4"
                              onclick="openModal()">Edit Accessories</button>
                          </div>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <button type="button"
                                onclick="addInputBox(document.getElementById('modal-nested-container'))"
                                class="btn bg-primary-subtle text-primary mt-3">
                                Add Accessories
                              </button>
                      ...
                      <div class="col-6" id="part_name" style="display:none">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="part_name" id="part_name"
                            value="<?= old('part_name', $asset['part_name'] ?? ''); ?>"
                        ...
                        <div class="mb-3">
                          ...
                          <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="part_number"
                              id="partNumberInput" value="<?= old('part_number', $asset['part_number']); ?>"
                              placeholder="Enter or Select Part Number" data-bs-toggle="dropdown" aria-expanded="false"
                              autocomplete="off" />
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer d-flex gap-3">
                          ...
                          <a href="<?= base_url('deleteasset/' . $asset['id']); ?>" id="btn-confirm-delete"
