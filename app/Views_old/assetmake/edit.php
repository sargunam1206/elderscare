            ...
            <nav class="sidebar-nav" id="menu-right-mini-0" data-simplebar>
              <ul class="sidebar-menu" id="sidebarnav">
                ...
                <!li class="sidebar-item ">
                  ...
                  <!-- Admin Topic -->
                  <li
                    class="sidebar-item <?php if (strpos($current_url, 'assettype') !== false || strpos($current_url, 'assetmake') !== false || strpos($current_url, 'dealers') !== false || strpos($current_url, 'uom') !== false)
                      echo 'active'; ?>">
                    ...
                    <ul aria-expanded="true" class="collapse first-level show">
                      ...
                      <!-- Asset Type -->
                      <li class="sidebar-item <?php if (strpos($current_url, 'assettype') !== false)
                        echo 'active'; ?>">
                        <a class="sidebar-link has-arrow" href="#"
                          aria-expanded="<?= strpos($current_url, 'assettype') !== false ? 'true' : 'false'; ?>">
                          <span class="hide-menu">Asset Type</span>
                        </a>
                        <ul aria-expanded="<?= strpos($current_url, 'assettype') !== false ? 'true' : 'false'; ?>"
                          class="collapse second-level <?= strpos($current_url, 'assettype') !== false ? 'show' : ''; ?>">
                          <li class="sidebar-item <?php if ($current_url == base_url('assettype'))
                            echo 'active'; ?>">
                          ...
                          <li
                            class="sidebar-item <?php if ($current_url == base_url('viewassettype'))
                              echo 'active'; ?>">
                      ...
                      <!-- Asset Make -->
                      <li class="sidebar-item <?php if (strpos($current_url, 'assetmake') !== false)
                        echo 'active'; ?>">
                        <a class="sidebar-link has-arrow" href="#"
                          aria-expanded="<?= strpos($current_url, 'assetmake') !== false ? 'true' : 'false'; ?>">
                          <span class="hide-menu">Asset Make</span>
                        </a>
                        <ul aria-expanded="<?= strpos($current_url, 'assetmake') !== false ? 'true' : 'false'; ?>"
                          class="collapse second-level <?= strpos($current_url, 'assetmake') !== false ? 'show' : ''; ?>">
                          <li class="sidebar-item <?php if ($current_url == base_url('assetmake'))
                            echo 'active'; ?>">
                          ...
                          <li
                            class="sidebar-item <?php if ($current_url == base_url('viewassetmake'))
                              echo 'active'; ?>">
                          ...
                          <li
                            class="sidebar-item <?php if (strpos($current_url, 'editassetmake') !== false)
                              echo 'active'; ?>">
                      ...
                      <!-- Dealer Name -->
                      <li class="sidebar-item <?php if (strpos($current_url, 'dealers') !== false)
                        echo 'active'; ?>">
                        <a class="sidebar-link has-arrow" href="#"
                          aria-expanded="<?= strpos($current_url, 'dealers') !== false ? 'true' : 'false'; ?>">
                          <span class="hide-menu">Dealer Name</span>
                        </a>
                        <ul aria-expanded="<?= strpos($current_url, 'dealers') !== false ? 'true' : 'false'; ?>"
                          class="collapse second-level <?= strpos($current_url, 'dealers') !== false ? 'show' : ''; ?>">
                          <li class="sidebar-item <?php if ($current_url == base_url('dealers'))
                            echo 'active'; ?>">
                            <a class="sidebar-link" href="<?= base_url('dealers'); ?>">
                              <span class="icon-small"></span>Add Dealer Name
                            </a>
                          </li>
                          <li class="sidebar-item <?php if ($current_url == base_url('viewdealers'))
                            echo 'active'; ?>">
                      ...
                      <!-- UOM -->
                      <li class="sidebar-item <?php if (strpos($current_url, 'uom') !== false)
                        echo 'active'; ?>">
                        <a class="sidebar-link has-arrow" href="#"
                          aria-expanded="<?= strpos($current_url, 'uom') !== false ? 'true' : 'false'; ?>">
                          <span class="hide-menu">UOM</span>
                        </a>
                        <ul aria-expanded="<?= strpos($current_url, 'uom') !== false ? 'true' : 'false'; ?>"
                          class="collapse second-level <?= strpos($current_url, 'uom') !== false ? 'show' : ''; ?>">
                          <li class="sidebar-item <?php if ($current_url == base_url('uom'))
                            echo 'active'; ?>">
                            <a class="sidebar-link" href="<?= base_url('uom'); ?>">
                              <span class="icon-small"></span>Add UOM
                            </a>
                          </li>
                          <li class="sidebar-item <?php if ($current_url == base_url('viewuom'))
                            echo 'active'; ?>">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <form method="post" action="<?= base_url('updateassetmake/' . $assetmakes['id']); ?>"
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control dropdown-toggle w-100" name="asset_make"
                            id="assetMakeInput" placeholder="Enter or Select Asset Type"
                            value="<?= old('asset_make', $assetmakes['asset_make']); ?>" aria-expanded="false"
                            autocomplete="off" />
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer d-flex gap-3">
                          ...
                          <a href="<?= base_url('deleteassetmake/' . $assetmakes['id']); ?>" id="btn-confirm-delete"
