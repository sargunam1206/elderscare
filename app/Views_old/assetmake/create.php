            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('assetmake'); ?>" enctype="multipart/form-data">
                  <div class="card-body">
                    <h4 class="card-title">Add Asset Make</h4>
<?php 
  ...
  <div class="row">
    <div class="col-6">
      <div class="mb-3">
        ...
        <div class="dropdown">
          <input type="text" class="form-control dropdown-toggle w-100" name="asset_make" placeholder="Enter Asset make"  aria-expanded="false" autocomplete="off" />
