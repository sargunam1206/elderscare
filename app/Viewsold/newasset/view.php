            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">View Asset</h4>
...
<?php endif; ?>                 
        ...
        <button type="submit" name="submit" value="download" class="btn btn-primary">Download PDF</button>
            ...
            <button type="submit" name="submit" value="excel" formaction="<?= base_url('asset/downloadexcel'); ?>" class="btn btn-primary">Excel</button--> <!-- Excel Button -->
        <!--/div>
    </div-->
    <!--form method="post" action="//?= base_url('asset/download'); ?>">
...
<form action="<//?= site_url('asset/downloadexcel') ?>" method="post">
  ...
  <tr>
    <td class="p-1">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu p-3" aria-labelledby="assetTypeDropdown" style="max-height: 200px; overflow-y: auto;">
          <input type="text" class="form-control mb-2 w-100" id="assetTypeSearch" placeholder="Search Asset Type" autocomplete="off" />
    ...
    <td class="p-1">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu p-3" aria-labelledby="assetMakeDropdown" style="max-height: 200px; overflow-y: auto;">
          <input type="text" class="form-control mb-2 w-100" id="assetMakeSearch" placeholder="Search Asset Makes" autocomplete="off" />
          <div class="form-check">
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu p-3" aria-labelledby="dealerDropdown" style="max-height: 200px; overflow-y: auto;">
      <input type="text" class="form-control mb-2 w-100" id="dealerSearch" placeholder="Search Dealers" autocomplete="off" />
      <div class="form-check">
      ...
      <div id="dealerList">
        <!-- Dynamic dealer checkboxes will be populated here -->
      </div>
      <div class="mt-2">
        <button type="submit" class="btn btn-light btn-sm w-100" id="applyDealerFilters">Apply Filters</button>
      </div>
    </ul>
  </div>
</td>
    ...
    <td class="p-1">
      <div class="dropdown">
        <button class="btn btn-info dropdown-toggle w-100" type="button" id="MaterialDropdown" data-bs-toggle="dropdown" aria-expanded="false">
          Material
        </button>
        <ul class="dropdown-menu p-3" aria-labelledby="MaterialDropdown" style="max-height: 200px; overflow-y: auto;">
          <input type="text" class="form-control mb-2 w-100" id="MaterialsSearch" placeholder="Search Materials" autocomplete="off" />
          <div class="form-check">
    ...
    <td class="p-1">
      <div class="dropdown">
        <button class="btn btn-info dropdown-toggle w-100" type="button" id="PartnumberDropdown" data-bs-toggle="dropdown" aria-expanded="false">
          Part Number
        </button>
        <ul class="dropdown-menu p-3" aria-labelledby="PartnumberDropdown" style="max-height: 200px; overflow-y: auto;">
          <input type="text" class="form-control mb-2 w-100" id="PartnumbersSearch" placeholder="Search Part Number" autocomplete="off" />
          <div class="form-check">
    ...
    <td class="p-1">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu p-3" aria-labelledby="customerDropdown" style="max-height: 200px; overflow-y: auto;">
          ...
          <div id="customerList">
            <!-- Dynamic customer checkboxes will be populated here -->
          </div>
          <div class="mt-2">
            <button type="submit" class="btn btn-light btn-sm w-100" id="applyFilters">Apply Filters</button>
          </div>
    ...
    <td class="p-1">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu p-3" aria-labelledby="locationDropdown" style="max-height: 200px; overflow-y: auto;">
          ...
          <div id="locationList">
            <!-- Dynamic location checkboxes will be populated here -->
          </div>
          <div class="mt-2">
            <button type="submit" class="btn btn-light btn-sm w-100" id="applyFilters">Apply Filters</button>
          </div>
...
Rooms" />
          ...
          <div id="roomList">
            <!-- Dynamic room checkboxes will be populated here -->
          </div>
          <div class="mt-2">
            <button type="submit" class="btn btn-light btn-sm w-100" id="applyFilters">Apply Filters</button>
          </div>
    ...
    <td class="p-1">
    <button type="submit" name="submit" value="excel" formaction="<?= base_url('asset/downloadexcel'); ?>" class="btn btn-primary"> Download Excel</button> <!-- Excel Button -->
    </td>
  </tr>
...
fetch('<?= base_url('asset1/all_part_numbers'); ?>')
  ...
  .then((partnumbers) => {
    ...
    partnumbers.forEach((partnumber) => {
      ...
      listItem.innerHTML = `
        <div class="form-check">
          <input class="form-check-input partnumber-checkbox" type="checkbox" name="partnumber_filters[]" value="${partnumber.part_number}" id="partnumber${partnumber.part_number}" />
          <label class="form-check-label" for="partnumber${partnumber.part_number}">
