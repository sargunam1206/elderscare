...
<?php endif; ?>                    
  ...
  <div class="row">
    <div class="col-6">
      <div class="mb-3">
        ...
        <div class="dropdown">
          <input type="text" class="form-control dropdown-toggle w-100" name="asset_type" id="assetTypeInput" placeholder="Enter or Select Asset Type" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off"readonly />
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="customer_name" class="form-label">Customer Name</label>
          <div class="dropdown">
            <input type="text" class="form-control dropdown-toggle w-100" name="customer_name" id="customerNameInput" placeholder="Enter or Select Customer Name" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
              <ul class="dropdown-menu p-3 w-100" aria-labelledby="customerNameInput" style="max-height: 150px; overflow-y: auto;">
                ...
                <input type="text" class="form-control mb-2" id="customerNameSearch" placeholder="Search Customer" autocomplete="off" />
                  <div id="customerList" style="width: 100%;">
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="asset_make" class="form-label">Asset Make</label>
          <div class="dropdown">
            <input type="text" class="form-control dropdown-toggle w-100" name="asset_make" id="assetMakeInput" placeholder="Enter or Select Asset Make" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly/>
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="purpose" id="purposeInput" placeholder="Enter or Select Purpose" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="specification" id="specification" placeholder="Enter the specification" autocomplete="off" />
      </div>
    </div>
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="uom" id="uomInput" placeholder="Enter Unit of Measurement (UOM)" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly/>
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="current_stock" id="current_stock" placeholder="Enter Current Stock" autocomplete="off" />
      </div>
    </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="calibration_id" id="calibration_id" placeholder="Enter Calibration Id" autocomplete="off" />
  </div>
</div>
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="reorder_level" id="reorder_level" placeholder="Enter the Reorder Level" autocomplete="off" />
      </div>
    </div>
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="serial_id" id="serial_id" placeholder="Enter Serial Id" autocomplete="off" />
      </div>
    </div>
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="dealer_name" id="dealerNameInput" placeholder="Enter or Select Dealer Name" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly/>
      <ul class="dropdown-menu p-3 w-100" aria-labelledby="dealerNameInput" style="max-height: 150px; overflow-y: auto;">
        <!-- Search box inside the dropdown -->
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="location" class="form-label">Location</label>
          <div class="dropdown">
            <input type="text" class="form-control dropdown-toggle w-100" name="location" id="locationInput" placeholder="Enter or Select Location" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
              <ul class="dropdown-menu p-3 w-100" aria-labelledby="locationInput" style="max-height: 150px; overflow-y: auto;">
                ...
                <div id="locationList" style="width: 100%;">
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="room" class="form-label">Room</label>
          <div class="dropdown">
            <input type="text" class="form-control dropdown-toggle w-100" name="room" id="roomInput" placeholder="Enter or Select Room" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="grade" id="grade" placeholder="Enter Grade" autocomplete="off" />
      </div>
    </div>
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="grn" class="form-label">Goods Recevied Number (GRN)</label>
        <input type="text" class="form-control" name="grn" id="grn" value="<?= isset($grn) ? $grn : ''; ?>" readonly />
      </div>
    </div>
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="material" class="form-label">Material</label>
          <div class="dropdown">
            <input type="text" class="form-control dropdown-toggle w-100" name="material" id="materialInput" placeholder="Enter or Select Material" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
              <ul class="dropdown-menu p-3 w-100" aria-labelledby="materialInput" style="max-height: 150px; overflow-y: auto;">
                ...
                <div id="materialList" style="width: 100%;">
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="part_name" id="part_name" placeholder="Enter the Part Name" autocomplete="off" />
      </div>
    </div>

    <div class="col-6">
      <div class="mb-3">
         <label for="conno2" class="form-label">Resharpening</label>
          <select name="resharpening" class="form-control">
              <option value="">Select Resharpening (Y/N)</option>
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="part_number" class="form-label">Part Number</label>
          <div class="dropdown">
            <input type="text" class="form-control dropdown-toggle w-100" name="part_number" id="partNumberInput" placeholder="Enter or Select Part Number" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  fetch('<?= base_url('asset1/all_dealers'); ?>') // Update to your correct endpoint
    ...
    .then((data) => {
      ...
      dealerList.innerHTML = ''; // Clear any existing entries
  ...
  dealerSearch.addEventListener('input', function () {
    ...
    const dealerItems = document.querySelectorAll('#dealerList .dropdown-item');
    ...
    if (!matchFound) {
      dealerList.innerHTML = ''; // Optionally clear the list if desired
    }
  });
