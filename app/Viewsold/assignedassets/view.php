                    ...
                    <span class="hide-menu">Assigned Assets</span>
                     ...
                     <ul aria-expanded="false" class="collapse first-level">
                      ...
                      <li class="sidebar-item">
                           ...
                           if($assigned_assets_idchild!=''){
                             
                         ?> 
                        <a class="sidebar-link" href="<?= base_url('viewassignedassets/'.base64_encode(base64_encode(base64_encode($assigned_assets_idchild))));?>">
                             <?php }}else{ ?>
...
if(isset($session->success)):?>
 ...
 <?php endif; ?>                   
                  ...
                  <form method="post"  action="<?= base_url('viewassignedassets'); ?>">
                  <div class="row"> 
                    
                  <div class="col-md-3">
                  <h4 class="card-title">View Assigned Assets</h4>
                  </div>
                  ...
                  <select name="type" class="form-control" >
                      ...
                      <option value="DelAssets">Deleted Assets</option>
                  </select>
                  </div>
                 ...
                 <a href="<?= base_url('viewassignedassets'); ?>" class="btn btn-primary" >All Info</a>
                  </div>
                  </div>
                 ...
                 <form method="post" action="<?= base_url('downloadassignedassets'); ?>"
                ...
                <div class="table-responsive mt-3">
                  <table id="form_inputs"  class="table table-striped w-100 table-bordered display text-nowrap align-middle " style="width:100%">
                    <thead>
                      <!-- start row -->
                      <tr>
                        <th>GRN No</th>
                    ...
                    <tbody >
                     ...
                     <tr>
                        ...
                        <td><?= $assigned_assets_retureddate[$i]; ?></td>
                        <td><a href="<?= base_url('viewassignedassets/'.$base); ?>" class="btn btn-info">
                          Child Part List
                          </a> </td>
                        <td> <a href="<?= base_url('editassignedassets/'.$base); ?>" class="btn btn-info">
                          Update
                          </a>
                        </td>
                      </tr>
              ...
              <div class="card">
                ...
                ?>
                     <?php if($assigned_assets_childpart!=''){  ?>
                <div class="row"> 
