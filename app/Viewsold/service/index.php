                  ...
                  <a class="sidebar-link has-arrow" href="<?= base_url(); ?>/public/dist/main/index3.html" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                      ...
                      <span class="hide-menu">Services</span>
                       ...
                       <ul aria-expanded="false" class="collapse first-level">
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('request'); ?>">
                          <span class="icon-small"></span>Add Repair Request
                        </a>
                      </li>
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('viewrequest'); ?>">
                          <span class="icon-small"></span>View Request Info
                        </a>
                      </li>
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Repair Request</h4>
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('request'); ?>">
                  <div class="card-body">
                    <h4 class="card-title">Add Repair Request</h4>
<?php 
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="asset_id" id="title2" placeholder="Enter the Asset ID" />
                        </div>
                      </div>        
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="title2" class="form-label">Asset Name</label>
                          <input type="text" class="form-control" name="asset_name" id="title2" placeholder="Enter the Asset Name" />
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Request Date</label>
                                <input type="date" class="form-control" id="assets_part_name" name="req_date" placeholder="Enter the Request Date" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="email4" class="form-label">Issue</label>
                            <input type="text" class="form-control" name="issue"  id="email4" placeholder="Enter the issue" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="conno2" class="form-label">Priority</label>
