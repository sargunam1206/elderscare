...
if(isset($session->success)):?>
 ...
 <?php endif; ?>                   
                  ...
                  <div class="col-md-3">
                  <h4 class="card-title">View Assets Value</h4>
                  </div>
                  ...
                  <table id="form_inputs"  class="table table-striped w-100 table-bordered display text-nowrap align-middle ">
                    ...
                    <tbody >
                      ...
                      <?php foreach($alldata as $data){ 
                          $base=base64_encode(base64_encode(base64_encode($data['assetsvalue_id'])));
                      ?>
                      <tr>
                        <td ><?= $data['assets_grn_no']; ?></td>
                        <td><?= $data['assetsvalue_value']; ?></td>
                        
                         <?php if($assets_type=='DelAssets'){?>
                        <td><?= $data['assetsvalue_deleted_on']; ?></td>
                        <?php }else{ ?><td><?= $data['assetsvalue_created_on']; ?></td> <?php }?>
                        
                        <td> <a href="<?= base_url('editassetsvalue/'.$base); ?>" class="btn btn-info">
                          Update
                          </a>
                          </td>
                      </tr>
