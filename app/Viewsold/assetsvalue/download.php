...
Hosur - 635109, Tamilnadu, India</p>
                ...
                <tr>
                    <td colspan="16" class="text-center" align="center"><u><h2>Assets Value Report</h2></u></td>
                </tr>
                <tr>
                    <th colspan="5" class="text-center" align="center">S.No.</th>
                    <th colspan="6" class="text-center" align="center">GRN No.</th>
                    <th colspan="5" class="text-center" align="center">Asset Value</th>
                </tr>
                <tr>
             <?php 
             $i=1;
            ...
            <tr>
                <td colspan="5" class="text-center" align="center"><?= $i ?></td>
                <td colspan="6" class="text-center" align="center"><?= $asset['assets_grn_no'] ?></td>
                <td colspan="5" class="text-center" align="center"><?= $asset['assetsvalue_value'] ?? 'N/A' ?></td>
