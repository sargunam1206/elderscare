                ...
                <li class="sidebar-item ">
                  <a class="sidebar-link has-arrow" href="" id="get-url" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('assets'); ?>">
                          <span class="icon-small"></span>Add Assets
                        </a>
                      </li>
                      <li class="sidebar-item ">
                        <a class="sidebar-link" href="<?= base_url('viewassets'); ?>">
                  ...
                  <a class="sidebar-link has-arrow" href="<?= base_url(); ?>/public/dist/main/index3.html" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                      <a class="sidebar-link has-arrow" href="<?= base_url(); ?>/public/dist/main/eco-shop.html">
                       ...
                       <ul aria-expanded="false" class="collapse first-level">
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('purchase'); ?>">
                          <span class="icon-small"></span>Add Purchase Info
                        </a>
                      </li>
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('viewpurchase'); ?>">
                          <span class="icon-small"></span>View Purchase Info
                        </a>
                      </li>
                       <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('editpurchase/'.base64_encode(base64_encode(base64_encode($alldata['purchase_id'])))); ?>">
                          <span class="icon-small"></span>Edit Return Info
                        </a>
                      </li>
                    </ul>
                    </li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('updatepurchase'); ?>" enctype="multipart/form-data">
                  <div class="card-body">
...
<?php endif; ?>                    
                  ...
                  <div class="card-body border-top">
                    <div class="row">
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="fname3" class="form-label">Vendor</label>
                          <input type="hidden" value="<?= $alldata['purchase_id'];?>" name="purchase_id"> 
                          <input type="text" class="form-control" name="purchase_vendor" value="<?=   $alldata['purchase_vendor'];?>" id="fname3" placeholder="Enter the GRN No" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="title2" class="form-label">Asset Type</label>
                          <input type="text" class="form-control" name="purchase_asset_type" value="<?=   $alldata['purchase_asset_type'];?>" id="title2" placeholder="Enter the Asset Name" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="comname1" class="form-label">Model</label>
                          <input type="text" class="form-control" name="purchase_model" id="comname1" value="<?= $alldata['purchase_model'];?>" placeholder="Enter the Asset Brand" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="email4" class="form-label">Purchase Price</label>
                            <input type="text" class="form-control" name="purchase_price"  id="email4" value="<?= $alldata['purchase_price'];?>" placeholder="Enter the Vendor Name" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="conno2" class="form-label">Discount</label>
                            <input type="text" class="form-control" name="purchase_discount" id="conno2" value="<?= $alldata['purchase_discount'];?>" placeholder="Enter the Customer Name" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Units Acquired</label>
                                <input type="text" class="form-control" name="purchase_units_acquired"  value="<?= $alldata['purchase_units_acquired'];?>" id="conno2" placeholder="Enter the Party Name" />
                          </div>
                        </div>
                      </div>
                        <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Date Acquired</label>
                                <input type="text" class="form-control" name="purchase_date_acquired" value="<?= $alldata['purchase_date_acquired'];?>" id="conno2" placeholder="Enter the Qty Available" />
                          </div>
                        </div>
                      </div>
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Purchase Status</label>
                                <select name="purchase_status" class="form-control">
                                    <?php if(($alldata['purchase_status']!='')){?><option value="<?= $alldata['purchase_status'];?>"><?= $alldata['purchase_status'];?></option><?php } ?>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Asset Image</label><br>
                                <img src="<?= base_url().$alldata['purchase_asset_image']; ?>" height="200px" width="200px">
                                <input type="file" class="form-control" name="purchase_asset_image"  id="conno2" placeholder="Enter the Recorder Level" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Expense Ref ID</label>
                                <input type="text" class="form-control" name="purchase_expense_refid"  value="<?= $alldata['purchase_expense_refid'];?>" id="conno2" placeholder="Enter the Location" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Tax Type</label>
                                <input type="text" class="form-control" name="purchase_taxtype"  value="<?= $alldata['purchase_taxtype'];?>" id="conno2" placeholder="Enter the Room" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Tax %</label>
                                <input type="text" class="form-control" name="purchase_tax_percent" value="<?= $alldata['purchase_tax_percent'];?>" id="conno2" placeholder="Enter the Room" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Tax Exemption</label>
                                <input type="text" class="form-control" name="purchase_tax_exemption" value="<?= $alldata['purchase_tax_exemption'];?>" id="conno2" placeholder="Enter the Room" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <select name="purchase_delivery_sts" class="form-control">
                                    <?php if(($alldata['purchase_delivery_sts']!='')){?><option value="<?= $alldata['purchase_delivery_sts'];?>"><?= $alldata['purchase_delivery_sts'];?></option><?php } ?>
                                   <option value="">Select Status</option>
                  ...
                  <?php 
                          $base=base64_encode(base64_encode(base64_encode($alldata['purchase_id'])));
                      ?>
                    ...
                    <div class="d-flex flex-wrap gap-6 align-items-center">
                      <div>
                        <div class="text-center">
                          ...
                          <a href="javascript:void(0)" id="btn-add-contact" class="btn bg-danger-subtle text-danger">
                         Delete
                          </a>
                        </div>
                      </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer  align-items-center">
                    <div class="d-flex gap-6 m-0">
                      <a href="<?= base_url('deletepurchase/'.$base); ?>"  id="btn-add" class="btn btn-danger justify-content-center">Yes</a>
