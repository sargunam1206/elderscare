...
if(isset($session->success)):?>
 ...
 <?php endif; ?>                   
                  ...
                  <form method="post"  action="<?= base_url('viewpurchase'); ?>">
                  <div class="row"> 
                 ...
                 <input type="date" class="form-control" name="to_date" id="conno2" placeholder="Enter the Qty Available"/>
                  ...
                  <div class="col-md-3 ">
                      <br>
                  <label for="conno2" class="form-label">Vendor</label>
                  <select name="purchase_vendor" class="form-control" >
                      <option value="">Select Vendor</option>
                       <?php
                      
                         foreach($allvalues as $info){
                         $purchase_vendor[]=$info['purchase_vendor']; 
                         } 
                         
                         if(!isset($purchase_vendor)){
                         $purchase_vendor[]='';    
                         }
                       
                        $unique=array_unique($purchase_vendor);
                  ...
                  <div class="col-md-2 mt-2">
                      <br><br>
                        <button type="submit" name="submit" value="download"  formaction="<?= base_url('downloadpurchase'); ?>" class="btn btn-primary">PDF</button>
                    </div>
                  
                  <div class="col-md-2 mt-2">
                      <br><br><br>
                      <?php foreach($alldata as $data){ 
                          $total_value[]=$data['purchase_price'];
                        
                         } ?>
                        <h6>Total Value:<?= array_sum($total_value)?></h6>
                    </div>
                  </div>
                  </div>
                  </form>
                    ...
                    <tbody >
                      ...
                      <tr>
                        ...
                        <td><?= $data['purchase_status']; ?></td>
                         <td><img src="<?php 
                            if($data['purchase_asset_image']!= '') { 
                                echo base_url() . $data['purchase_asset_image']; 
                            } else { 
                                echo 'pdfbankaccountdetails?filename=' . $data['purchase_asset_image'];
                            }  
                        ...
                        <td><?= $data['purchase_delivery_sts']; ?></td>
                          <?php if($assets_type=='DelAssets'){?>
                        <td><?= $data['purchase_deleted_on']; ?></td>
                        <?php }else{ ?><td><?= $data['purchase_created_on']; ?></td> <?php }?>
                        <td> <a href="<?= base_url('editpurchase/'.$base); ?>" class="btn btn-info">
                          Update
                          </a>
                         </td>
                      </tr>
