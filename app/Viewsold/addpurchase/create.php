        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('purchase1'); ?>" enctype="multipart/form-data">
                  <div class="card-body">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="grn" id="grn" value="<?= isset($grn) ? $grn : ''; ?>" readonly />
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="conno2" class="form-label">Accessories</label>
                            <input type="text" class="form-control" name="accessories" id="accessories" placeholder="Enter the Accessories" />
                          </div>
                        </div>
                      </div>
                      <div class="col-6">
