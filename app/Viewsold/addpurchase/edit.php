            ...
            <nav class="sidebar-nav" id="menu-right-mini-0" data-simplebar>
              <ul class="sidebar-menu" id="sidebarnav">
                ...
                <li class="sidebar-item ">
                  <a class="sidebar-link has-arrow" href="" id="get-url" aria-expanded="false">
                   ...
                   <ul aria-expanded="false" class="collapse first-level">
                    ...
                    <li class="sidebar-item">
                      ...
                      <li class="sidebar-item">
                       ...
                       <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('editpurchase1/'.base64_encode(base64_encode(base64_encode($purchase['grn'])))); ?>">
...
<div class="col-6">
        <div class="mb-3">
          <label for="tax" class="form-label">Accessories</label>
          <input type="text" class="form-control" name="accessories" id="accessories"
                 value="<?= $purchase['accessories']; ?>" placeholder="Enter the Accessories" />
        </div>
      </div>
