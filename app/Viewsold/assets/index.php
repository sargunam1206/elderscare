        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('assets'); ?>" enctype="multipart/form-data">
                  <div class="card-body">
...
<?php endif; ?>                    
                  ...
                  <div class="card-body border-top">
                    <div class="row">
                            <div class="col-12">
                        <div class="mb-3">
                          <label for="fname3" class="form-label">Asset Type</label>
                          <input type="text" class="form-control" name="assets_type" id="assets_type" autocomplete="off" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="fname3" class="form-label">Asset ID</label>
                          <input type="text" class="form-control" name="assets_grn_no" id="fname3" placeholder="" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="assets_brand" id="comname1" placeholder="Enter the Asset Brand" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="assets_vendor"  id="email4" placeholder="Enter the Vendor Name" />
                          </div>
                        </div>
                      </div>
                        <div class="col-12">
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="assets_customer_name" id="conno2" placeholder="Enter the Customer Name" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assets_party_name" id="conno2" placeholder="Enter the Party Name" />
                          </div>
                        </div>
                      </div>
                        <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assets_qty_avl" id="conno2" placeholder="Enter the Qty Available" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assets_rec_level" id="conno2" placeholder="Enter the Recorder Level" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assets_location" id="conno2" placeholder="Enter the Location" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="assets_room" id="conno2" placeholder="Enter the Room" />
                          </div>
                        </div>
                      </div>
  ...
  $("#assets_type").autocomplete({

  source: function( request, response ) {
        
   $.ajax({
     
      url: "<?= site_url('asset_type/') ?>"+request.term,
      type: 'get',
      dataType: "json",
