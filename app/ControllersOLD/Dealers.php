...
class Dealers extends BaseController
{
    ...
    public function update($id)
    {
        ...
        return redirect()->to('viewdealers')->with('success', 'Dealer Name updated successfully.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('viewdealers')->with('success', 'Dealer Name deleted successfully.');
    }
