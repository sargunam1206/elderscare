...
class Uom extends BaseController
{
    ...
    public function update($id)
    {
        ...
        return redirect()->to('viewuom')->with('success', 'Unit of Measurement (UOM) updated successfully.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('viewuom')->with('success', 'Unit of Measurement (UOM) deleted successfully.');
    }
