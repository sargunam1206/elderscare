...
class AssetMake extends BaseController
{
...

    {
      ...
      // Capture all form data
        ...
        return redirect()->to(base_url('viewassetmake'));
    ...
    public function update($id)
    {
        ...
        return redirect()->to('viewassetmake')->with('success', 'Asset Make updated successfully.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('viewassetmake')->with('success', 'Asset Make deleted successfully.');
    }
    ...
    public function delete_assetmakes()
    {
        ...
        if (isset($input->ids) && is_array($input->ids)) {
            ...
            if ($successCount > 0) {
                $this->session->setFlashdata('success', "$successCount asset make(s) deleted successfully.");
            }
            if ($errorCount > 0) {
                $this->session->setFlashdata('error', "$errorCount Asset Make(s) failed to be deleted. Please try again.");
            }
