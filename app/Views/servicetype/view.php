...
<div class="modal fade" id="vertical-center-scroll-modal" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <form method="post"  id="assetForm"  action="<?= base_url('addservicetype'); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
        <div class="modal-header d-flex align-items-center">
          <h4 class="modal-title" id="myLargeModalLabel">Add Service Type</h4>
     ...
     <div class="col-12">
      <!-- <div class="mb-3">
          <label for="room_no" class="form-label required">Name</label>
        <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100" name="name" id="name" placeholder="Enter Service Name "  autocomplete="off" />
...
<div class="col-12" id="part_number" >
    <div class="mb-3">
  <label for="descInput" class="form-label required">Description</label>

  <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100" name="description" id="descInput" placeholder="Enter Service Description "  autocomplete="off" />
    ...
    <div class="mb-3">
        <label for="descInput" class="form-label">Description <span class="text-danger">*</span></label>
...
<?php endif; ?>                
                  ...
                  <form method="post"  action="<?= base_url('addservicetype'); ?>">
                    
 
 <div class="d-flex justify-content-between align-items-center mb-3">
              <h5 class="fs-7"><i class="bi bi-tags text-success"></i>
Service Type</h5>
              <div>
  ...
  <thead>
        ...
        <!-- <th><input type="checkbox" id="select_all"></th>  -->
           <th>S.No</th>
    <th>Name</th> <!-- Decreased width -->
    <th >Description</th>     <!-- Increased width -->
    ...
    <tbody>
        ...
        <?php $i = 1; foreach ($servicetype as $asset):
...
<button type="button"
 ...
 <a href="javascript:void(0)" 
   class="btn " 
   data-bs-toggle="modal" 
   data-bs-target="#deleteConfirmationModal<?= $asset['service_type_id']; ?>">
 <i class="bi bi-trash text-danger"></i>
            ...
            <div class="modal fade" id="deleteConfirmationModal<?= $asset['service_type_id']; ?>" tabindex="-1" aria-labelledby="deleteModalTitle<?= $asset['service_type_id']; ?>" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header d-flex align-items-center">
        <h5 class="modal-title" id="deleteModalTitle<?= $asset['service_type_id']; ?>">Are you sure you want to delete?</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-footer d-flex gap-3 justify-content-end">
        <!-- Confirm Delete Button -->
        <a href="<?= base_url('deleteservicetype/' . $asset['service_type_id']); ?>" class="btn btn-danger">Yes</a>
...
function editAsset(asset) {
  ...
  document.getElementById('myLargeModalLabel').textContent = "Edit Service Type";

  // Update form action to update URL
  const form = document.getElementById("assetForm");
  form.action = "<?= base_url('updateservicetype') ?>/" + asset.service_type_id ;
  
  // Set all input values
  document.getElementById("name").value = asset.	name || '';

  document.getElementById('descInput').value = asset.description || '';
...
document.getElementById('vertical-center-scroll-modal').addEventListener('hidden.bs.modal', function () {
    document.getElementById('myLargeModalLabel').textContent = "Add Service Type";
  const form = document.getElementById('assetForm');
  form.reset();
  document.getElementById('addaccessory-container').innerHTML = '';
  form.action = "<?= base_url('servicetype'); ?>"; // Reset to "Add" mode
