...
<div class="main-wrapper overflow-hidden" style="background-color:#EDF7EE;">
  <div class="" >
  <div class="card-header d-flex justify-content-between align-items-center" style="background-color:#EDF7EE;">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="dropdown">
                        <input type="text" class="form-control dropdown-toggle w-100" name="gender_display" id="genderInput"
                          placeholder="Select Gender" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly required />
                    ...
                    <div class="mb-3">
                      ...
                      <div class="dropdown">
                        <input type="text" class="form-control dropdown-toggle w-100" name="religion_display" id="religionInput"
                          placeholder="Select Religion" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly required />
                    ...
                    <div class="mb-3">
                      ...
                      <div class="dropdown">
                        <input type="text" class="form-control dropdown-toggle w-100" name="education_display" id="educationInput"
                          placeholder="Select Education" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly required />
                    ...
                    <div class="mb-3">
                      ...
                      <div class="dropdown">
                        <input type="text" class="form-control dropdown-toggle w-100" name="marital_status_display" id="maritalStatusInput"
                          placeholder="Select Status" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly required />
...
document.addEventListener('DOMContentLoaded', function() {
  // Form validation
  const form = document.getElementById('guestMasterForm');
  ...
  // Initialize relationship dropdown for the first guardian form
  ...
  // Fix for date input max attribute
