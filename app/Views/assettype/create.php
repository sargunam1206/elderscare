            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('assettype'); ?>" enctype="multipart/form-data">
                  <div class="card-body">
                    <h4 class="card-title">Add Asset Type</h4>
<?php 
...
<form method="post" action="/assettype/store">
  ...
  <div class="row">
    <div class="col-6">
      <div class="mb-3">
        ...
        <div class="dropdown">
          <input type="text" class="form-control dropdown-toggle w-100" name="asset_type" id="assetTypeInput" placeholder="Enter Asset Type" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
  ...
  <?php foreach ($input_field as $label): ?>
