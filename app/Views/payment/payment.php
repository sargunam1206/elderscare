                    ...
                    <button class="btn btn-success ms-5"  type="submit" id="completePaymentBtn">
                        ...
                        <div id="payment-forms">
                            ...
                            <form method="post" action="<?= base_url('payrecord'); ?>">
                                ...
                                <input type="hidden" name="services_info[]"
                                    value="<?= htmlspecialchars(json_encode($services_info), ENT_QUOTES, 'UTF-8') ?>">
                                ...
                                <div id="card-form" class="payment-form" style="display:none">
                                    <div class="mb-3">
                                        <label class="form-label">Transcation ID</label>
                                        <input type="text" class="form-control" name="card_trans"
                                ...
                                <div class="action-buttons mt-5">
                                    ...
                                    <button class="btn btn-success ms-6" name="submit" type="submit"
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>All payments must be made in full before services are rendered. We accept cash, credit cards, and
                        approved digital payment methods.</p>

                    <h6>2. Cancellation Policy</h6>
                    <p>Cancellations must be made at least 24 hours prior to the scheduled service time to receive a
                        full refund.</p>

                    <h6>3. Service Guarantee</h6>
                    <p>We guarantee all services will be performed to the highest standards. If you're not satisfied,
                        please notify us within 24 hours.</p>

                    <h6>4. Liability</h6>
                    <p>The hotel is not responsible for any personal items left in rooms or with staff during service
                        provision.</p>
                </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>We collect personal information necessary to provide our services, including name, contact
                        details, and payment information.</p>

                    <h6>2. Data Usage</h6>
                    <p>Your information will only be used to process your requests and improve our services. We will
                        never sell your data to third parties.</p>
                    ...
                    <h6>4. Your Rights</h6>
                    <p>You have the right to access, correct, or delete your personal information at any time by
                        contacting our front desk.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">I Understand</button>
                </div>
