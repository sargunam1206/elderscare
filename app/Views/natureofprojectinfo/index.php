...
<div class="container-fluid">
            ...
            <div class="card card-info" >
              ...
              <form method="POST" action="<?= site_url('natureproject');?>" class="form-horizontal" enctype="multipart/form-data" >
                <div class="card-body">
                    
                      <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Project Name</label>
                      <div class="col-sm-10">
                        <input list="project_id"  class="form-control" name="project_id"   id="check1" autocomplete="off"/>
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Project Type</label>
                      <div class="col-sm-10">
                         <input type="text"  name="project_work_type" class="form-control"  id="projecttype" placeholder="Designation" readonly/>
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Project Work Type List</label>
                      <div class="col-sm-10">
                        ...
                        <select name="project_work_type_list" id="project_work_type_list" class="form-control">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Employee Role</label>
                      <div class="col-sm-10">
                          <input type="text"  class="form-control" name="nature_of_project_emp_role" placeholder="Role" />
                       </div>
                    </div>  
