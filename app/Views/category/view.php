...
<div class="modal fade" id="vertical-center-scroll-modal" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <form method="post"  id="assetForm"  action="<?= base_url('addcategory'); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
     ...
     <div class="col-12">
      <div class="mb-3">
        ...
        <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100" name="category_name" id="category_name" placeholder="Enter Category Name "  autocomplete="off" required/>
  ...
  <div class="dropdown">
   ...
   <div class="col-12">
      <div class="mb-3">
        ...
        <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100" name="short_code" id="short_code" placeholder="Enter Short Code "  autocomplete="off" required/>
          <div class="invalid-feedback">
