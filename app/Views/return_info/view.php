                ...
                <li class="sidebar-item ">
                  <a class="sidebar-link has-arrow" href="<?= base_url(); ?>/public/dist/main/index3.html" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                      ...
                      <li class="sidebar-item">
                               <?php 
                           if(isset($return_childpartid)){
                           if($return_childpartid!=''){
                             
                         ?> 
                        <a class="sidebar-link" href="<?= base_url('viewreturn/'.base64_encode(base64_encode(base64_encode($return_childpartid))));?>">
                             <?php }}else{ ?>
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Returns</h4>
...
if(isset($session->success)):?>
 ...
 <?php endif; ?>                   
                  ...
                  <form method="post"  action="<?= base_url('viewreturn'); ?>">
                  <div class="row"> 
                    
                  <div class="col-md-3">
                  <h4 class="card-title">View Returns</h4>
                  </div>
              
                 <div class="col-md-2 ">
                    <label for="conno2" class="form-label">From Date</label>
                 <input type="date" class="form-control" name="from_date" id="conno2" placeholder="Enter the Qty Available"/>

                  </div>
                   <div class="col-md-2">
                    <label for="conno2" class="form-label">To Date</label>
                 <input type="date" class="form-control" name="to_date" id="conno2" placeholder="Enter the Qty Available"/>

                  </div>
                  
                  <div class="col-md-2 ">
                  <label for="conno2" class="form-label">Type of Value</label>
                  <select name="type" class="form-control" >
                      <option value="">Select Type</option>
                      <option value="Assets">Not Deleted</option>
                      <option value="DelAssets">Deleted</option>
                  </select>
                  </div>
                ...
                <br>
                 <a href="<?= base_url('viewreturn'); ?>" class="btn btn-primary" >All Info</a>
                  </div>
                  </div>
                    ...
                    <form method="post" action="<?= base_url('downloadreturn'); ?>"
                  ...
                  <table id="form_inputs"  class="table table-striped w-100 table-bordered display text-nowrap align-middle">
                    <thead>
                      ...
                      <tr>
                        ...
                        <th>Approved By</th>
                        <th>Return Qty</th>
                        <th>Child Part List</th>
                          <?php if($assets_type=='DelAssets'){?>
                        <th>Deleted On</th>
                    ...
                    <tbody >
                      ...
                      <?php foreach($alldata as $data){ 
                          $base=base64_encode(base64_encode(base64_encode($data['return_id'])));
                          $base1=base64_encode(base64_encode(base64_encode($data['assets_grn_no'])));
                           if(isset($return_childpartid)){
                           if($return_childpartid==$data['assets_grn_no']){
                      ...
                      <tr>
                        ...
                        <td><?= $data['returned_date']; ?></td>
                        <td><?= $data['returned_by']; ?></td>
                        <td><?= $data['approved_by']; ?></td>
                        <td><?= $data['return_qty']; ?></td>
                        
                        <td><a href="<?= base_url('viewreturn/'.$base1); ?>" class="btn btn-info">
                          Child Part List
                          </a> </td>
                        
                          <?php if($assets_type=='DelAssets'){?>
                        <td><?= $data['return_deleted_on']; ?></td>
                        <?php }else{ ?><td><?= $data['return_created_on']; ?></td> <?php }?>
                       
                       
                        <td> <a href="<?= base_url('editreturn/'.$base); ?>" class="btn btn-info">
                          Update
                          </a>
                         </td>
                      </tr>
              ...
              <div class="card">
                <div class="card-body"> 
                   <?php if(isset($assigned_assets_childpart)){
                      
                  
                ?>
                     <?php if($assigned_assets_childpart!='' or $assigned_assets_childpart!=null ){  ?>
                <div class="row"> 
                    
                  <div class="col-md-6">
                  <h4 class="card-title">List of Child Part</h4>
                  </div>
                  ...
                  <ul class="list-group">
                      ...
                      $decode=json_decode($assigned_assets_childpart);
                           $i=1;
                      foreach($decode as $dataone) {?>
                  ...
                  ?>
                    ...
                    <h4 class="card-title mb-3">Child Part -Info</h4>
             ...
             <div class="col-lg-6">
              <div class="card">
                <div class="card-body"> 
                   <?php if(isset($return_childpart)){
                  
                ?>
                     <?php if($return_childpart!='' or $return_childpart!=null){  ?>
                <div class="row"> 
                    
                  <div class="col-md-6">
                  <h4 class="card-title">Not  Returned Child Part</h4>
                  </div>
                  ...
                  <ul class="list-group">
                      ...
                      $decode1=json_decode($return_childpart);
                      
                      
                   
                        $i1=1;
                        if($decode1!=''){
                             $not_retured=array_diff($decode,$decode1);
                      foreach($not_retured as $dataone1) { 
