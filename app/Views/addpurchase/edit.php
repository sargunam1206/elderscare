...
<li class="sidebar-item <?= $isPurchaseActive ? 'active' : '' ?>">
  <a class="sidebar-link" href="<?= base_url('editpurchase1/'.base64_encode(base64_encode(base64_encode($purchase['purchase_id'])))); ?>">
 ...
 <li class="sidebar-item">
                  <a class="sidebar-link" href="http://freelance.neuralarc.com/digitalflow/" target="_blank">
                    ...
                    <!-- <li class="sidebar-item">
                      ...
                      <li class="sidebar-item">
                       ...
                       <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('editpurchase1/'.base64_encode(base64_encode(base64_encode($purchase['purchase_id'])))); ?>">
                          <span class="icon-small"></span>Edit Purchase Info
                        </a>
                      </li>
                      <li class="sidebar-item">
    ...
    <a href="<?= base_url('viewpurchase1'); ?>" class="btn btn-primary">Purchase List</a>
        ...
        <div class="card-body wizard-content">
                      ...
                      <?php endif; ?>  
            <h4 class="card-title mb-2"> Edit Purchase Entry</h4>
            <h6 class="card-subtitle mb-3">Edit the existing purchase record in the system</h6>
...
<div class="stepper-wrapper d-flex justify-content-between mb-4">
  ...
  <div class="stepper-item text-center s4N" onclick="goToStep(4)">
    ...
    <div class="step-name d-none ">Accessories </div>
            ...
            <form method="post" id="myForm" action="<?= base_url('updatepurchase1'); ?>" id="nestedInputForm" class="tab-wizard wizard-circle icon-round" enctype="multipart/form-data">
                <!-- Step 1 Content -->
                <div class="step-content active" id="step-1-content">
                    <!-- <h4 class="step-title mb-4">Basic Purchase Detail</h4> -->
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="conno2" class="form-label required">Purchase ID</label>
                                <input type="text" class="form-control" name="purchase1_id"value="<?= $purchase['purchase1_id']; ?>" id="purchase1_id" placeholder="Enter the Purchase ID" required/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="conno2" class="form-label required">Order Date</label>
                                <input type="date" class="form-control" id="order_date" name="order_date" value="<?= $purchase['order_date']; ?>"placeholder="Enter the Order Date" required />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            ...
                            <label for="supplier_name" class="form-label required">Dealer Name</label>
                                <input type="hidden" value="<?= $purchase['grn']; ?>" name="grn" >
                                <div class="dropdown">
                                    <input type="text" class="form-control dropdown-toggle w-100" name="supplier_name" id="supplierNameInput"
                                        value="<?= $purchase['supplier_name']; ?>" placeholder="Select Dealer Name" data-bs-toggle="dropdown"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" value="<?= $purchase['grn']; ?>" name="grn" >
                            <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="purchase_reason" id="purchaseReasonInput"
                                    value="<?= $purchase['purchase_reason']; ?>" placeholder="Enter or Select Purpose" data-bs-toggle="dropdown"
                                    aria-expanded="false" autocomplete="off" required />
                            <ul class="dropdown-menu p-3 w-100" aria-labelledby="purchaseReasonInput" style="max-height: 150px; overflow-y: auto;">
                                ...
                                <!-- Dynamic purchase reason list will be populated here -->
                                </div>
                            </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="customer_name" value="<?= $purchase['customer_name']; ?>" id="customer_name" placeholder="Enter the Customer Name" />
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="d-flex justify-content-end gap-2 me-4">
                    ...
                    <!--button type="button" class="btn btn btn-info" onclick="resetForm()">Cancel</button-->
                </div>
                </div>
                ...
                <div class="step-content" id="step-2-content">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" value="<?= $purchase['purchase_id']; ?>" name="purchase_id" >
                            <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="asset_type" id="assetTypeInput"
                                    value="<?= $purchase['asset_type']; ?>" placeholder="Select Asset Type" data-bs-toggle="dropdown"
                                    aria-expanded="false" autocomplete="off" required />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control dropdown-toggle w-100" name="asset_make" id="assetMakeInput"
                                    value="<?= $purchase['asset_make']; ?>" placeholder="Select Asset Make" data-bs-toggle="dropdown"
                                    aria-expanded="false" autocomplete="off" required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="part_name" value="<?= $purchase['part_name']; ?>" id="part_name" placeholder="Enter the Part Name" required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="conno2" class="form-label">Part Number</label>
                                <input type="text" class="form-control" name="part_number" value="<?= $purchase['part_number']; ?>" id="part_number" placeholder="Enter the Part Number" />
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="comname1" class="form-label">Specification</label>
                                <input type="text" class="form-control" name="specification" id="specification" value="<?= $purchase['specification']; ?>"  placeholder="Enter the Specifications" style="height: 70px;" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="material" id="material" value="<?= $purchase['material']; ?>" placeholder="Enter the Material" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="grade" id="grade"value="<?= $purchase['grade']; ?>"  placeholder="Enter the Grade" />
                                </div>
                            </div>
                        </div>
                         <div class="col-6">
                        <div class="mb-3">
                            <label for="asset_make" class="form-label required">Unit of Measurement (UOM)</label>
                            <input type="hidden" value="<?= $purchase['grn']; ?>" name="grn" >
                            <div class="dropdown">
                            <input type="text" class="form-control dropdown-toggle w-100" name="uom" id="uomInput"
                                    value="<?= $purchase['uom']; ?>" placeholder="Select UOM" data-bs-toggle="dropdown"
                                    aria-expanded="false" autocomplete="off" required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="quantity" id="quantity"value="<?= $purchase['quantity']; ?>"  placeholder="Enter the Stock Purchased" required/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="step-content" id="step-3-content">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <div class="mb-3"> 
                                    ...
                                    <input type="text" class="form-control" name="unit_price" value="<?= $purchase['unit_price']; ?>" id="unit_price" placeholder="Enter the Unit Price" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="total_cost" id="total_cost" value="<?= $purchase['total_cost']; ?>" placeholder="Enter the Total cost"  />
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="invoice_number"value="<?= $purchase['invoice_number']; ?>"  id="invoice_number" placeholder="Enter the Invoice Number" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="invoice_date" name="invoice_date" value="<?= $purchase['invoice_date']; ?>" placeholder="Enter the Invoice Date" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="grn" id="grn" value="<?= isset($purchase['grn']) ? $purchase['grn'] : ''; ?>" readonly />                            </div>
                        </div>
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <div class="dropdown">
                              <input type="text"
                                    ...
                                    aria-expanded="false"
                                    value="<?= isset($purchase['delivery_status']) ? $purchase['delivery_status'] : '' ?>" 
                                    required />
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            <label for="purchase_status_input" class="form-label required">Purchase Status</label>
                            <div class="dropdown">
                              <input type="text"
                                    class="form-control dropdown-toggle w-100"
                                    id="purchase_status_input"
                                    name="purchase_status"
                                    placeholder="Select Purchase Status"
                                    data-bs-toggle="dropdown"
                                    aria-expanded="false"
                                    value="<?= isset($purchase['purchase_status']) ? $purchase['purchase_status'] : '' ?>"
                                    required
                                     />
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="received_qty" value="<?= $purchase['received_qty']; ?>" id="received_qty" placeholder="Enter the Received Quantity" />
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="location" id="location" value="<?= $purchase['location']; ?>" placeholder="Enter the Location" />
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="room" value="<?= $purchase['room']; ?>" id="room" placeholder="Enter the Room" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="hasAccessories" id="no" value="no" 
                                    <?= (isset($purchase['hasAccessories']) && $purchase['hasAccessories'] == 'no') ? 'checked' : '' ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="hasAccessories" id="yes" value="yes" 
                                    <?= (isset($purchase['hasAccessories']) && $purchase['hasAccessories'] == 'yes') ? 'checked' : '' ?>>
...
<div class="mb-2 text-end">
  <strong class="border rounded px-3 py-2 d-inline-block ">Total Accessory Cost : <span class="accessories-total">₹0.00</span></strong>
  <input type="hidden" id="accessoryData" name="accessoryData" value="">
</div>
                      </div>
          ...
          <?php $resharpenValue = ucfirst(strtolower(trim($purchase['resharpen'] ?? ''))); ?>
          <div class="mb-3">
            ...
            <div class="dropdown">
              <input type="text"
                    ...
                    value="<?= htmlspecialchars($resharpenValue ?: 'Not Applicable') ?>"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                    readonly />
  ...
  <div class="upload-box text-center p-3 border border-double rounded position-relative" id="uploadArea" style="cursor: pointer;">
    <div class="mb-2">
    ...
    <?php if (!empty($purchase['asset_image'])): ?>
      <div class="mt-2">
        <a href="<?= base_url($purchase['asset_image']); ?>" target="_blank" data-bs-toggle="modal" class="text-success fw-bold" data-bs-target="#imageModal">View Image</a>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              <img src="<?= base_url($purchase['asset_image']); ?>" alt="Asset Image" class="img-fluid" />
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- File name preview -->
    <div id="filePreview" class="mt-2 small text-secondary"></div>
  </div>
</div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4 me-4">
                        ...
                        <button type="submit" name="submit" value="true" class="btn btn-success">Update</button>
                        <!--button type="button" class="btn btn btn-info" onclick="resetForm()">Cancel</button-->
                    </div>
...
<!-- Place this at the BOTTOM of your HTML file, just before the closing </body> tag -->
   ...
   function openModal() {
    ...
    // Add "Add Accessories" button
    /*const addButton = document.createElement("button");
    addButton.textContent = "Add Accessories";
    addButton.type = "button";
    addButton.className = "btn bg-primary-subtle text-primary mt-3";
    addButton.onclick = () => addInputBox(container); // Add accessories if clicked
...
function saveAccessories() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function toggleReorderField() {
            if (purchaseStatus.value === 'Assets Received') {
                reorderDiv.style.display = 'block';
            } else {
                reorderDiv.style.display = 'none';
                reorderInput.value = ''; // Reset reorder input
            }
        }

        // Run on page load for edit
        toggleReorderField();

        // Add event listener for change
        purchaseStatus.addEventListener('change', toggleReorderField);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  fetch('<?= base_url('purchase1/all_asset_types'); ?>')
    .then((response) => response.json())
    .then((data) => {
      assetTypes = data.map((type) => type.asset_type.toLowerCase()); // Store lowercase asset types for comparison
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  fetch('<?= base_url('purchase1/all_asset_makes'); ?>')
    .then((response) => response.json())
    .then((data) => {
      assetMakes = data.map((make) => make.asset_make.toLowerCase()); // Store lowercase asset makes for comparison
...
//   document.getElementById('accessoryUnitPrice').value = accessory.unitPrice || ''; // 🔁 fix here

//   document.getElementById('saveAccessoryBtn').setAttribute('data-edit-index', index);
...
// function populateAccessoryModal(index, accessory) {
//   // Fill form fields
//   document.getElementById('accessoryName').value = accessory.name || '';
//   document.getElementById('accessoryQuantity').value = accessory.quantity || '';
//   document.getElementById('accessoryType').value = accessory.type || '';
//   document.getElementById('accessoryUnitPrice').value = accessory.unitPrice || '';
...
<script>
// Initialize accessories array from PHP
let accessories = <?= !empty($accessoriesData) ? json_encode($accessoriesData) : '[]' ?>;
let accessoryToDeleteIndex = null;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("accessoryQuantity").addEventListener("input", calculateTotal);
    document.getElementById("accessoryUnitPrice").addEventListener("input", calculateTotal);

    // Dropdown selection for accessory type
    document.querySelectorAll('#accessoryTypeList .dropdown-item').forEach(item => {
        item.addEventListener('click', function (e) {
            e.preventDefault();
            const value = this.getAttribute('data-value');
            document.getElementById('accessoryTypeInput').value = value;
        });
    });
    ...
    // Submit hidden data
    const form = document.getElementById("nestedInputForm");
    if (form) {
...
function calculateTotal() {
    const qty = parseInt(document.getElementById("accessoryQuantity").value) || 0;
...
function saveAccessory() {
    ...
    const total = parseFloat(document.getElementById('accessoryTotal').value);
    const errorBox = document.getElementById('accessoryError');

    if (!name || !type || isNaN(quantity) || quantity <= 0 || isNaN(unit_price) || unit_price <= 0) {
        errorBox.innerText = "Please fill all fields correctly.";
    ...
    const editIndex = saveBtn.getAttribute("data-edit-index");

    if (editIndex !== null && editIndex !== "") {
        accessories[parseInt(editIndex)] = newAccessory;
        saveBtn.removeAttribute("data-edit-index");
        saveBtn.textContent = "Add Accessory";
    } else {
...
function updateAccessoryTable() {
    ...
    if (accessories.length === 0) {
        tbody.innerHTML = "<tr><td colspan='6'>No accessories added yet</td></tr>";
    } else {
        accessories.forEach((acc, index) => {
            grandTotal += acc.total || 0;
            ...
            row.innerHTML = `
                ...
                <td>
          <a href="javascript:void(0);" class="btn btn-sm text-primary" onclick="editAccessory(${index})" title="Edit">
...
function editAccessory(index) {
    ...
    document.getElementById('accessoryQuantity').value = acc.quantity;
    document.getElementById('accessoryTypeInput').value = acc.type;
    document.getElementById('accessoryUnitPrice').value = acc.unit_price;
    document.getElementById('accessoryTotal').value = acc.total.toFixed(2);

    const saveBtn = document.getElementById("saveAccessoryBtn");
    saveBtn.setAttribute("data-edit-index", index);
    saveBtn.textContent = "Update Accessory";

    bootstrap.Modal.getOrCreateInstance(document.getElementById('addAccessoryModal')).show();
}
...
//     accessoryToDeleteIndex = index;
//     bootstrap.Modal.getOrCreateInstance(document.getElementById('deleteConfirmationModal')).show();
// }

// function confirmDelete() {
//     if (accessoryToDeleteIndex !== null) {
//         accessories.splice(accessoryToDeleteIndex, 1);
//         updateAccessoryTable();
//         accessoryToDeleteIndex = null;
//     }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateAccessorySectionDisplay() {
    const selected = document.querySelector('input[name="hasAccessories"]:checked');
  ...
  // Run on DOM load to reflect database value (edit case)
  updateAccessorySectionDisplay();

  // Bind change event to radios
  radios.forEach(radio => {
    radio.addEventListener('change', updateAccessorySectionDisplay);
  });
});
</script> -->
<script>
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateAccessorySectionDisplay() {
    const selected = document.querySelector('input[name="hasAccessories"]:checked');
    if (!selected || selected.value.trim().toLowerCase() !== 'yes') {
      // Hide if no radio selected, or if value is not 'yes'
      accessorySection.classList.add('d-none');
    } else {
      // Show if 'yes'
      accessorySection.classList.remove('d-none');
  ...
  updateAccessorySectionDisplay(); // On load
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  uploadArea.addEventListener("click", function (e) {
    const isClickableElement =
      e.target.closest("a") || e.target.closest(".modal") || e.target.classList.contains("btn-close");
  ...
  fileInput.addEventListener("change", function () {
    ...
    if (files.length > 0) {
      filePreview.innerHTML = files.map(f => `<div>${f.name}</div>`).join('');
    }
  });
});
</script>
...
<!-- 
<script>
// Initialize accessories array with PHP data if available
let accessories = <?= !empty($accessoriesData) ? json_encode($accessoriesData) : '[]' ?>;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("nestedInputForm").addEventListener("submit", function() {
        document.getElementById("accessoryData").value = JSON.stringify(accessories);
    });
});
...
function saveAccessory() {
    ...
    const unitPrice = parseFloat(document.getElementById('accessoryUnitPrice').value);
    const errorBox = document.getElementById('accessoryError');

    // Validation
    if (!name || isNaN(quantity) || !type || isNaN(unitPrice)) {
        errorBox.innerText = "Please fill all fields correctly.";
        errorBox.style.display = "block";
        return;
    }
    ...
    if (editIndex !== null) {
        ...
        accessories[editIndex] = newAccessory;
        this.removeAttribute('data-edit-index');
        this.textContent = 'Add Accessory';
    } else {
        // Add new accessory
        accessories.push(newAccessory);
    }
...
function updateAccessoryTable() {
    ...
    if (accessories.length === 0) {
        ...
        accessories.forEach((acc, index) => {
            ...
            row.innerHTML = `
                ...
                <td>${acc.quantity}</td>
                <td>${acc.type}</td>
                <td>₹${acc.unitPrice?.toFixed(2) || '0.00'}</td>
                <td>₹${acc.total?.toFixed(2) || '0.00'}</td>
                <td>
                    <button type="button" class="btn btn-sm btn-warning" onclick="editAccessory(${index})">Edit</button>
                    <button type="button" class="btn btn-sm btn-danger" onclick="removeAccessory(${index})">Remove</button>
                </td>
            `;
            tbody.appendChild(row);
        });
    ...
    // Update grand total and hidden field
    document.querySelector(".accessories-total").textContent = `₹${grandTotal.toFixed(2)}`;
    document.getElementById("accessoryData").value = JSON.stringify(accessories);
}
...
function editAccessory(index) {
    ...
    new bootstrap.Modal(document.getElementById('addAccessoryModal')).show();
}
...
document.getElementById("saveAccessoryBtn").addEventListener("click", function () {
    ...
    // Validation
    if (!name || !quantity || !type || isNaN(unitPrice)) {
        document.getElementById("accessoryError").style.display = 'block';
        document.getElementById("accessoryError").textContent = 'All fields are required.';
        return;
    }

    // Add to array
    const accessory = { name, quantity, type, unit_price: unitPrice, total };
    ...
    row.innerHTML = `
        ...
        <td>₹${total}</td>
        <td><button type="button" class="btn btn-danger btn-sm" onclick="removeAccessory(this)">Remove</button></td>
    `;
...
function updateAccessoriesTotal() {
    ...
    document.querySelector('.accessories-total').textContent = `₹${total.toFixed(2)}`;
}

function removeAccessory(button) {
    const row = button.closest('tr');
    const index = row.rowIndex - 1; // minus 1 to skip thead
    accessories.splice(index, 1);
    row.remove();
    updateAccessoriesTotal();
    document.getElementById("accessoryData").value = JSON.stringify(accessories);
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header d-flex align-items-center">
                    <h5 class="modal-title d-flex justify-content-center">Are you sure you want delete? </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                 
                  <div class="modal-footer  align-items-center">
                    <div class="d-flex gap-6 m-0">
                      <a href="<//?= base_url('deletepurchase1/'.$base); ?>"  id="btn-add" class="btn btn-danger justify-content-center">Yes</a>
                      <!-button id="btn-edit" class="btn btn-success">No</button->
...
//       uploadArea.innerHTML = files.map(f => `<div>${f.name}</div>`).join('');
//     }
//   });
});
fileInput.addEventListener("change", function () {
  ...
  if (files.length > 0) {
    ...
    // ✅ DON'T overwrite entire upload area (removes file input)
    const fileListHtml = files.map(f => `<div>${f.name}</div>`).join('');
    const filePreview = document.createElement("div");
    filePreview.innerHTML = fileListHtml;
    
    uploadArea.appendChild(filePreview); // ✅ append instead of replace
  }
}); -->
...
<!-- <script>
  function goToStep(stepNumber) {
    ...
    if (stepItems[stepNumber - 1]) {
      stepItems[stepNumber - 1].classList.add("active");
    }

    // Hide all step contents and show the current one
...
function goToStep(stepNumber) {
  ...
  stepItems.forEach((item, index) => {
    ...
    if (index + 1 === stepNumber) {
      ...
      if (stepName) stepName.classList.remove("d-none"); // Show only current
    }
  });
