        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('purchase'); ?>" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="purchase_vendor" id="fname3" placeholder="Enter the Vendeor Name " />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="title2" class="form-label">Asset Type</label>
                          <input type="text" class="form-control" name="purchase_asset_type" id="title2" placeholder="Enter the Asset Type" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="comname1" class="form-label">Model</label>
                          <input type="text" class="form-control" name="purchase_model" id="comname1" placeholder="Enter the Asset Brand" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="purchase_price"  id="email4" placeholder="Enter the Vendor Name" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="purchase_discount" id="conno2" placeholder="Enter the Customer Name" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="purchase_units_acquired" id="conno2" placeholder="Enter the Party Name" />
                          </div>
                        </div>
                      </div>
                        <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="purchase_date_acquired" id="conno2" placeholder="Enter the Qty Available" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="purchase_expense_refid" id="conno2" placeholder="Enter the Location" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="purchase_taxtype" id="conno2" placeholder="Enter the Room" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="purchase_tax_percent" id="conno2" placeholder="Enter the Room" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="purchase_tax_exemption" id="conno2" placeholder="Enter the Room" />
                          </div>
                        </div>
                      </div>
