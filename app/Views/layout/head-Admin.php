...
<header class="app-header shadow-sm" style="background-color:#419045;">
 ...
 Home
          ...
          <!-- Dashboard -->
          <li class="nav-item">
            <a class="nav-link text-white fw-semibold <?= ($activePage == 'admindashboard') ? 'active' : '' ?>" 
               href="<?= base_url('admindashboard'); ?>">
...
<li class="nav-item dropdown">
  ...
  <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="servicesDropdown">
    <li>
      <a class="dropdown-item <?= ($activePage == '') ? 'active' : '' ?>" 
         href="<?= base_url('servicetype'); ?>">
        Service Type
      </a>
    </li>
    <li>
...
<li class="nav-item dropdown">
  ...
  <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="onboardingDropdown">
    <li>
      <a class="dropdown-item <?= ($activePage == '') ? 'active' : '' ?>" href="<?= base_url('act'); ?>">
        Activities
      </a>
    </li>
    <li>
      <a class="dropdown-item <?= ($activePage == '') ? 'active' : '' ?>" href="<?= base_url('not'); ?>">
        Noticeboard
      </a>
    </li>
    <li>
