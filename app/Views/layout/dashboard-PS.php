        ...
        <div class="row g-4 justify-content-center">
          ...
          <div class="col-md-3">
            <div class="card shadow-sm border-0 text-center h-100">
              <a href="<?= base_url("chargesrept"); ?>">
                <div class="card-body">
                  <i class="bi bi-chat-dots fs-1 text-success mb-2"></i> <!-- Icon -->
                  <h6 class="text-success">Maintenance Charges</h6>
                  <h2 class="fw-bold">₹<?= $yearlypaidamt; ?></h2>
                  <p class="text-muted small">Total charges this year</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="card shadow-sm border-0 text-center h-100">
              <a href="<?= base_url("servicerept"); ?>">
                <div class="card-body">
                  <i class="bi bi-calendar-check fs-1 text-primary mb-2"></i> <!-- Icon -->
                  <h6 class="text-primary">Service Charges</h6>
                  <h2 class="fw-bold">₹<?= $service_total_amount; ?></h2>
                  <p class="text-muted small">Total charges this year</p>
                </div>
              </a>
            </div>
