...
<header class="app-header shadow-sm  fixed-top " style="background-color:#419045;">
 ...
 Home
          ...
          <!-- Dashboard -->
          <li class="nav-item">
            <a class="nav-link text-white fw-semibold <?= ($activePage == 'dashboard') ? 'active' : '' ?>" 
 ...
 Dashboard
          ...
          <!-- Enquiry -->
          <li class="nav-item">
            <a class="nav-link text-white fw-semibold <?= ($activePage == 'enquiry') ? 'active' : '' ?>" 
               href="<?= base_url('enquiry'); ?>">
              <i class="ti ti-clipboard-text me-1 fs-5"></i> Enquiry
            </a>
          </li>
          ...
          <!--  <a class="nav-link fw-semibold text-white <?= ($activePage == 'viewguestinfo' || $activePage == 'guestinfo') ? 'active' : '' ?>" -->
          <!--     href="<?= base_url('viewguestinfo'); ?>">-->
          <!--    <i class="bi bi-info-circle me-1 fs-4"></i> Guest Info-->
          <!--  </a>-->
          <!--</li>-->
