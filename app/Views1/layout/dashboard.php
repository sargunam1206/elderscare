...
<li class="sidebar-item">
  <a class="sidebar-link" href="https://freelance.neuralarc.com/digitalflow/" target="_blank">
                    ...
                    <div class="col">
                      <div class="card bg-info-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Total Assets</h6>
                    ...
                    <div class="col">
                      <div class="card bg-danger-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Total Assets Value</h6>
                          <h4 class="mb-3 d-flex align-items-center justify-content-center gap-1">
                            148</h4>
                          <a href="javascript:void(0)" class="btn btn-white fs-2 fw-semibold text-nowrap">View
                            Details</a>
                    ...
                    <div class="col">
                      <div class="card bg-warning-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Assigned Assets</h6>
                          <h4 class="mb-3 d-flex align-items-center justify-content-center gap-1">
                            $156K</h4>
                          <a href="javascript:void(0)" class="btn btn-white fs-2 fw-semibold text-nowrap">View
                            Details</a>
                    ...
                    <div class="col">
                      <div class="card bg-info-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Unassigned Assets</h6>
                          <h4 class="mb-3 d-flex align-items-center justify-content-center gap-1">
                            16,689</h4>
                          <a href="javascript:void(0)" class="btn btn-white fs-2 fw-semibold text-nowrap">View
                            Details</a>
                    ...
                    <div class="col">
                      <div class="card bg-danger-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Monthly Purchase Cost</h6>
                          <h4 class="mb-3 d-flex align-items-center justify-content-center gap-1">
                            148</h4>
                          <a href="javascript:void(0)" class="btn btn-white fs-2 fw-semibold text-nowrap">View
                            Details</a>
                    ...
                    <div class="col">
                      <div class="card bg-warning-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Monthly Assets Used</h6>
                          <h4 class="mb-3 d-flex align-items-center justify-content-center gap-1">
                            $156K</h4>
                          <a href="javascript:void(0)" class="btn btn-white fs-2 fw-semibold text-nowrap">View
                            Details</a>
                    ...
                    <div class="col">
                      <div class="card bg-info-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Cost of Assets Per Customer</h6>
                          <h4 class="mb-3 d-flex align-items-center justify-content-center gap-1">
                              <br>
                    ...
                    <div class="col">
                      <div class="card bg-danger-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Assets Depreciation Cost</h6>
                          <h4 class="mb-3 d-flex align-items-center justify-content-center gap-1">
                            <br></h4>
                          <a href="javascript:void(0)" class="btn btn-white fs-2 fw-semibold text-nowrap">View
                            Details</a>
                    ...
                    <div class="col">
                      <div class="card bg-warning-subtle overflow-hidden shadow-none">
                        <div class="card-body text-center px-9 pb-4">
                          ...
                          <h6 class="fw-normal fs-3 mb-1">Assets Return</h6>
                          <h4 class="mb-3 d-flex align-items-center justify-content-center gap-1">
                            <br></h4>
                          <a href="javascript:void(0)" class="btn btn-white fs-2 fw-semibold text-nowrap">View
                            Details</a>
