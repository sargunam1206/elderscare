        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('purchase1'); ?>" id="nestedInputForm" enctype="multipart/form-data">
                  <div class="card-body">
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="purchase1_id" id="purchase1_id" placeholder="Enter the Purchase ID" />
                          </div>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="mb-3">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="order_date" name="order_date" placeholder="Enter the Order Date" />
                          </div>
                        </div>
                      </div>
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="asset_type" id="assetTypeInput" 
             placeholder="Select Asset Type" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
...
<div class="col-6">
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="purchase_reason" id="purchaseReasonInput" placeholder="Enter or Select Purpose" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="asset_make" id="assetMakeInput"
             placeholder="Select Asset Make" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
          ...
          <!-- Dynamic UOM list will be populated here -->
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="specification" id="specification" placeholder="Enter the Specifications" />
                        </div>
                      </div>
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Invoice Date</label>
                                <input type="date" class="form-control" id="invoice_date" name="invoice_date" placeholder="Enter the Invoice Date" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Stock Purchased</label>
                                <input type="text" class="form-control" name="quantity" id="quantity" placeholder="Enter the Stock Purchased" />
                          </div>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Invoice Number</label>
                                <input type="text" class="form-control" name="invoice_number" id="invoice_number" placeholder="Enter the Invoice Number" />
                          </div>
                        </div>
                      </div>
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="supplier_name" id="supplierNameInput" 
             placeholder="Select Dealer Name" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" />
...
<div class="col-6">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Asset Image</label>
...
<div class="col-6">
  <div class="mb-3">
    <div class="mb-3">
      ...
      <div>
      <button type="button" onclick="openModal()" class="btn bg-danger-subtle text-danger ms-6 px-4">Add Accessories</button>
      </div>
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="part_name" id="part_name" placeholder="Enter the Part Name" />
                          </div>
                        </div>
                      </div>
...
<div class="col-6">
                    ...
                    <div class="col-6">
                      ...
                      <div class="col-6" id="reorder_div" style="display: none;">
    <div class="mb-3">
        <label for="reorder" class="form-label">Reorder Level</label>
        <input type="number" class="form-control" name="reorder" id="reorder" placeholder="Enter the Reorder Level" />
    </div>
</div>
    <div class="col-6">
                        <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap gap-6 align-items-center">
                      <div>
                        <div class="text-center">
                          <button type="submit" name="submit1" value="true" class="btn btn-primary">
                            Save
                          </button>
