...
<body>
 ...
 <!-- Sidebar Start -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
             <form method="post" action="<?= base_url('updatepurchase1'); ?>" enctype="multipart/form-data">
  <!-- Hidden field for ID -->
  <div class="card-body">
  ...
  <form action="<?= base_url('updatepurchase'); ?>" method="post" enctype="multipart/form-data">
   ...
   <div class="row">
               ...
               <div class="col-6">
                        <div class="mb-3">
                            <div class="mb-3">
                                <label for="conno2" class="form-label">Purchase ID</label>
                                <input type="text" value="<?= $purchase['purchase1_id']; ?>" class="form-control" name="purchase1_id" id="purchase1_id" placeholder="Enter the Purchase ID" />
                          </div>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="mb-3">
                            <div class="mb-3">
                                <label for="conno2" class="form-label">Order Date</label>
                                <input type="date" value="<?= $purchase['order_date']; ?>" class="form-control" id="order_date" name="order_date" placeholder="Enter the Order Date" />
                          </div>
                        </div>
                      </div>  
 ...
 <div class="col-6">
  <div class="mb-3">
    <label for="purchase_reason" class="form-label">Purpose</label>
 ...
 <div class="col-6">
  <div class="mb-3">
    <label for="asset_make" class="form-label">Unit of Measurement (UOM)</label>
    <input type="hidden" value="<?= $purchase['grn']; ?>" name="grn">
    <div class="dropdown">
      ...
      <div class="col-6">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="specification" id="specification"
                 value="<?= $purchase['specification']; ?>" placeholder="Enter the Specifications" />
        </div>
      </div>
    ...
    <div class="row">
       ...
       <div class="col-6">
        <div class="mb-3">
          <label for="quantity" class="form-label">Stock Purchased</label>
          <input type="text" class="form-control" name="quantity" id="quantity"
                 value="<?= $purchase['quantity']; ?>" placeholder="Enter the Stock Purchased" />
        </div>
      </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="invoice_number" id="invoice_number"
                 value="<?= $purchase['invoice_number']; ?>" placeholder="Enter the Invoice Number" readonly/>
        </div>
      </div>
    </div>
    <div class="row">
     <div class="col-6">
        <div class="mb-3">
          <div class="mb-3">
                <label for="conno2" class="form-label">Unit Price</label>
                <input type="text" class="form-control" name="unit_price" id="unit_price" placeholder="Enter the Unit Price" />
          </div>
        </div>
    </div>
    <div class="col-6">
  ...
  <div class="row">
      ...
      <div class="col-6">
  <div class="mb-3">
    <label for="supplier_name" class="form-label">Dealer Name</label>
    <input type="hidden" value="<?= $purchase['grn']; ?>" name="grn">
    <div class="dropdown">
 ...
 <div class="col-6">
        <div class="mb-3">
          <label for="discount" class="form-label">Location</label>
          <input type="text" class="form-control" name="location" id="location"
                 value="<?= $purchase['location']; ?>" placeholder="Enter the location" />
        </div>
      </div>
    ...
    <div class="row">
     ...
     <div class="col-6">
  <div class="mb-3">
    <label for="comname1" class="form-label">Asset Image</label><br>

   

    <!-- File Input -->
    <input type="file" class="form-control" name="asset_image" id="conno2" placeholder="Enter the Recorder Level" />
    <?php if ($purchase['asset_image'] != ''): ?>
      <!-- Image Link -->
      <a href="<?= base_url($purchase['asset_image']); ?>" 
         target="_blank" 
         data-bs-toggle="modal" 
         data-bs-target="#imageModal">View Image</a>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              <img src="<?= base_url($purchase['asset_image']); ?>" 
                   alt="Asset Image" 
 ...
 <div class="col-6">
        <div class="mb-3">
          <label for="part_number" class="form-label">Room</label>
          <input type="text" class="form-control" name="room" id="room"
                 value="<?= $purchase['room']; ?>" placeholder="Enter the room" />
        </div>
      </div>
    </div>
    ...
    <div class="row">
     ...
     <div class="col-6">
       <div class="mb-3">
         <label for="invoice_number" class="form-label">Grade</label>
         <input type="text" class="form-control" name="grade" id="grade"
                value="<?= $purchase['grade']; ?>" placeholder="Enter the Grade" />
       </div>
     </div>
      ...
      <div class="col-6">
    <div class="mb-3">
        <label for="purchase_id" class="form-label">GRN</label>
        <input type="text" class="form-control" name="grn" id="grn" value="<?= isset($purchase['grn']) ? $purchase['grn'] : ''; ?>" readonly />
    </div>
</div>
    </div>
   ...
   <div class="col-6">
       <div class="mb-3">
         <label for="invoice_number" class="form-label">Material</label>
         <input type="text" class="form-control" name="material" id="material"
                value="<?= $purchase['material']; ?>" placeholder="Enter the material" />
       </div>
     </div>
   ...
   <div class="col-6">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="part_name" id="part_name"
                 value="<?= $purchase['part_name']; ?>" placeholder="Enter the Part Name" />
        </div>
      </div>
      ...
      <div class="col-6">
        <div class="mb-3">
          <label for="purchase_status" class="form-label">Resharpen</label>
          <select name="resharpen" class="form-control">
            <option value="">Select resharpen</option>
            <option value="Yes" <?= $purchase['resharpen'] == 'Yes' ? 'selected' : ''; ?>>Yes</option>
            <option value="No" <?= $purchase['resharpen'] == 'No' ? 'selected' : ''; ?>>No</option>
 ...
 <div class="col-6">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="part_number" id="part_number"
                 value="<?= $purchase['part_number']; ?>" placeholder="Enter the Part Number" />
        </div>
      </div>
    ...
    <div class="mb-3">
        ...
        <select name="purchase_status" id="purchase_status" class="form-control">
            ...
            <option value="Order Placed" <?= isset($purchase['purchase_status']) && $purchase['purchase_status'] == 'Order Placed' ? 'selected' : '' ?>>Order Placed</option>
            <option value="Assets Received" <?= isset($purchase['purchase_status']) && $purchase['purchase_status'] == 'Assets Received' ? 'selected' : '' ?>>Assets Received</option>
            <option value="Assets Pending" <?= isset($purchase['purchase_status']) && $purchase['purchase_status'] == 'Assets Pending' ? 'selected' : '' ?>>Assets Pending</option>
        </select>
    </div>
</div>
    </div>
     <div class="row">
         <div class="col-6">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Delivery Status</label>
 ...
 <div class="col-6">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="customer_name" id="customer_name"
                 value="<?= $purchase['customer_name']; ?>" placeholder="Enter the Customer Name" />
        </div>
      </div>
      ...
      <div class="col-6">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Remarks</label>
                                <input type="text" class="form-control" name="remarks" id="remarks" placeholder="Enter the Remarks" />
                          </div>
                        </div>
                      </div>   
     <div class="col-6">
    <div class="mb-3" id="reorder_div" style="display: none;">
        <label for="reorder" class="form-label">Reorder Level</label>
        <input 
            type="number" 
            class="form-control" 
            name="reorder" 
            ...
            value="<?= isset($purchase['reorder']) ? $purchase['reorder'] : '' ?>" />
    </div>
</div>
    </div>
...
<div class="modal fade" id="validationModal" tabindex="-1" aria-labelledby="validationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Reorder value should be less than stock purchase value.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
    ...
    <?php 
                          $base=base64_encode(base64_encode(base64_encode($purchase['grn'])));
                      ?>
    ...
    <div class="p-3 border-top">
      <div class="d-flex flex-wrap gap-6 align-items-center">
        <div class="text-center">
          ...
          <a href="javascript:void(0)" id="btn-add-contact" class="btn bg-danger-subtle text-danger">Delete</a>
        </div>
      </div>
    </div>
  </form>
