...
?>
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="<?= site_url('updatemanpower');?>" class="form-horizontal">
                <div class="card-body">
                <input type="hidden" name="manpower_request_id" value="<?= $user['manpower_request_id']; ?>">    
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select name="project_id" class="form-control">
                         ...
                         <option value="<?= $user['project_id'] ?>"><?= $project_name['project_name']; ?></option>
                         <?php } ?>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                     <select name="manpower_request_dept" class="form-control">
                         ...
                         <option value="<?= $user['manpower_request_dept'] ?>"><?= $department_name['department_name']; ?></option>
                         <?php } ?>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="manpower_request_job_title" value="<?= $user['manpower_request_job_title']?>" class="form-control" id="manpower_request_job_title">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      ...
                      <select name="manpower_request_job_type" class="form-control">
                         <?php if(isset($user['manpower_request_job_type'])){ ?>
                         <option value="<?= $user['manpower_request_job_type'] ?>"><?= $user['manpower_request_job_type']; ?></option>
                         <?php } ?>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                     <select name="manpower_request_job_hiretype" class="form-control">
                         <?php if(isset($user['manpower_request_job_hiretype'])){ ?>
                         <option value="<?= $user['manpower_request_job_hiretype'] ?>"><?= $user['manpower_request_job_hiretype']; ?></option>
                         <?php } ?>
                         <option value="">Select Type</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <textarea name="manpower_request_justify" class="form-control"><?= $user['manpower_request_justify']?></textarea>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <textarea name="manpower_request_major_res"  class="form-control"> <?= $user['manpower_request_major_res']?></textarea>
                    </div>
                  </div>
                   <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Qualification</label>
                    <div class="col-sm-10">
                    <input type="text" name="manpower_request_qualification" value="<?= $user['manpower_request_qualification'] ?>" class="form-control" id="manpower_request_qualification">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                    <input type="text" name="manpower_request_experience" value="<?= $user['manpower_request_experience'] ?>" class="form-control" id="manpower_request_experience">
                    </div>
                   </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" name="manpower_request_special_apilites" value="<?= $user['manpower_request_special_apilites'] ?>" class="form-control" id="manpower_request_special_apilites">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Personal Qualities</label>
                    <div class="col-sm-10">
                    <input type="text" name="manpower_request_personal_quality" value="<?= $user['manpower_request_personal_quality'] ?>" class="form-control" id="manpower_request_personal_quality">
                    </div>
                  </div>
