...
<?php endif; ?> 
  ...
  <div class="row">
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <div class="dropdown">
          <input type="text" class="form-control dropdown-toggle w-100" name="asset_type" id="assetTypeInput" placeholder="Select Asset Type" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off"  readonly  />
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="asset_make" class="form-label">Asset Make</label>
          <div class="dropdown">
            <input type="text" class="form-control dropdown-toggle w-100" name="asset_make" id="assetMakeInput" placeholder="Select Asset Make" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly/>
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="uom" id="uomInput" placeholder="Select Unit of Measurement (UOM)" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly/>
  ...
  <div class="mb-3">
    ...
    <div class="dropdown">
      <input type="text" class="form-control dropdown-toggle w-100" name="dealer_name" id="dealerNameInput" placeholder="Select Dealer Name" data-bs-toggle="dropdown" aria-expanded="false" autocomplete="off" readonly/>
...
<div class="col-6" id="accessories" style="display:none">
    <div class="mb-3">
        <label for="accessories" class="form-label">Accessories</label>
        <div>
            <button type="button" class="btn bg-danger-subtle text-danger px-4" onclick="openModal()">Add Accessories</button>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="button" onclick="addInputBox('modal-nested-container')" class="btn bg-primary-subtle text-primary mt-3">Add Accessories</button>
      </div>
