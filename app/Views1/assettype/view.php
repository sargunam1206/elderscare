            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">View Asset Types</h4>
  ...
  <thead>
        ...
        <th><input type="checkbox" id="select_all"></th> <!-- Select all checkbox -->
            ...
            <th>Asset Type</th>
             ...
             <th style="width:100px">Form Field</th>
          ...
          // $base=base64_encode(base64_encode(base64_encode($asset['id'])));
            ...
            <td><input type="checkbox" class="row_checkbox" data-asset-id="<?= $asset['id']; ?>"></td>
               ...
               <td>
                   ...
                   <button class="btn btn-success image-thumbnail" 
                   
                    type="button"  data-info='<?php 
                    $test=$asset['asset_form_field'];
                    echo $test;
