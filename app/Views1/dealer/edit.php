                ...
                <li class="sidebar-item <?php if ($current_url == base_url('viewdealers')) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('viewdealers'); ?>">
                        <span class="icon-small"></span>View Dealer Name
                              ...
                              <li class="sidebar-item <?php if (strpos($current_url, 'editdealers') !== false) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('editdealers/'.$dealer['id']); ?>">
                        <span class="icon-small"></span>Edit Dealer Name
                    </a>
                </li>
            </ul>
        </li>
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-md-0 card-title"> Dealer's Name</h4>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form method="post" action="<?= base_url('updatedealers/' . $dealer['id']); ?>" enctype="multipart/form-data">
                        <div class="card-body">
                            <h4 class="card-title">Edit Dealer's Name</h4>
                            <?php 
          ...
          <input type="text" class="form-control dropdown-toggle w-100" name="dealer_name" placeholder="Enter Dealer Name"  value="<?= old('dealer_name', $dealer['dealer_name']); ?>" aria-expanded="false" autocomplete="off" />
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer d-flex gap-3">
        ...
        <a href="<?= base_url('deletedealers/' . $dealer['id']); ?>" id="btn-confirm-delete" class="btn btn-danger">
          Yes
        </a>
        <!-- Cancel Button -->
