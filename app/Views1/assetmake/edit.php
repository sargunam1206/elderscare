...
<!-- Admin Topic -->
<li class="sidebar-item <?php if(strpos($current_url, 'assettype') !== false || strpos($current_url, 'assetmake') !== false || strpos($current_url, 'dealers') !== false || strpos($current_url, 'uom') !== false) echo 'active'; ?>">
    ...
    <ul aria-expanded="true" class="collapse first-level show">
        ...
        <li class="sidebar-item <?php if(strpos($current_url, 'assettype') !== false) echo 'active'; ?>">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="<?= strpos($current_url, 'assettype') !== false ? 'true' : 'false'; ?>">
                <span class="hide-menu">Asset Type</span>
            </a>
            <ul aria-expanded="<?= strpos($current_url, 'assettype') !== false ? 'true' : 'false'; ?>" class="collapse second-level <?= strpos($current_url, 'assettype') !== false ? 'show' : ''; ?>">
        ...
        <li class="sidebar-item <?php if(strpos($current_url, 'assetmake') !== false) echo 'active'; ?>">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="<?= strpos($current_url, 'assetmake') !== false ? 'true' : 'false'; ?>">
                <span class="hide-menu">Asset Make</span>
            </a>
            <ul aria-expanded="<?= strpos($current_url, 'assetmake') !== false ? 'true' : 'false'; ?>" class="collapse second-level <?= strpos($current_url, 'assetmake') !== false ? 'show' : ''; ?>">
                ...
                <li class="sidebar-item <?php if (strpos($current_url, 'editassetmake') !== false) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('editassetmake/'.$assetmakes['id']); ?>">
                        <span class="icon-small"></span>Edit Asset Make
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="sidebar-item <?php if(strpos($current_url, 'dealers') !== false) echo 'active'; ?>">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="<?= strpos($current_url, 'dealers') !== false ? 'true' : 'false'; ?>">
                <span class="hide-menu">Dealer Name</span>
            </a>
            <ul aria-expanded="<?= strpos($current_url, 'dealers') !== false ? 'true' : 'false'; ?>" class="collapse second-level <?= strpos($current_url, 'dealers') !== false ? 'show' : ''; ?>">
        ...
        <li class="sidebar-item <?php if(strpos($current_url, 'uom') !== false) echo 'active'; ?>">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="<?= strpos($current_url, 'uom') !== false ? 'true' : 'false'; ?>">
                <span class="hide-menu">UOM</span>
            </a>
            <ul aria-expanded="<?= strpos($current_url, 'uom') !== false ? 'true' : 'false'; ?>" class="collapse second-level <?= strpos($current_url, 'uom') !== false ? 'show' : ''; ?>">
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-md-0 card-title">Asset Make</h4>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form method="post" action="<?= base_url('updateassetmake/' . $assetmakes['id']); ?>" enctype="multipart/form-data">
                        <div class="card-body">
                            <h4 class="card-title">Edit Asset Make</h4>
                            <?php 
                        ...
                        <div class="card-body border-top">
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="asset_type" class="form-label">Asset Make</label>
                                        
                                            <input 
                                                type="text" class="form-control dropdown-toggle w-100"  name="asset_make" id="assetMakeInput"  placeholder="Enter or Select Asset Type" value="<?= old('asset_make', $assetmakes['asset_make']); ?>"  aria-expanded="false"  autocomplete="off" 
                                            />
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer d-flex gap-3">
        ...
        <a href="<?= base_url('deleteassetmake/' . $assetmakes['id']); ?>" id="btn-confirm-delete" class="btn btn-danger">
          Yes
        </a>
        <!-- Cancel Button -->
