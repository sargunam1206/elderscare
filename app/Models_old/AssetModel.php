...
class AssetModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'location', 'room','current_stock', 'dealer_name', 'grade', 'purpose', 'uom', 'calibration_id', 'serial_id', 'grn', 'accessories', 'resharpening',
        'mc_type','machine_name','created_on', 'updated_on', 'deleted_on'
    ];
