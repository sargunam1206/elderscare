                ...
                <li class="sidebar-item <?php if ($current_url == base_url('viewuom')) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('viewuom'); ?>">
                        <span class="icon-small"></span>View UOM
                           ...
                           <li class="sidebar-item <?php if (strpos($current_url, 'edituom') !== false) echo 'active'; ?>">
                    <a class="sidebar-link" href="<?= base_url('edituom/'.$uom['id']); ?>">
                        <span class="icon-small"></span>Edit UOM
                    </a>
                </li>
            </ul>
        </li>
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Unit of Measurement (UOM) </h4>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('updateuom/'. $uom['id']); ?>" enctype="multipart/form-data">
                  <div class="card-body">
                    <h4 class="card-title">Edit Unit of Measurement (UOM)</h4>
<?php 
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="uom" class="form-label">Unit of Measurement (UOM)</label>
          <input type="text" class="form-control dropdown-toggle w-100" name="uom" placeholder="Enter Unit of Measurement (UOM)" value="<?= old('uom', $uom['uom']); ?>" aria-expanded="false" autocomplete="off" />
      </div>
    </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer d-flex gap-3">
        ...
        <a href="<?= base_url('deleteuom/' . $uom['id']); ?>" id="btn-confirm-delete" class="btn btn-danger">
          Yes
        </a>
        <!-- Cancel Button -->
