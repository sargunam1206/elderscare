            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('uom'); ?>" enctype="multipart/form-data">
                  <div class="card-body">
                    <h4 class="card-title">Add Unit of Measurement (UOM)</h4>
<?php 
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="uom" class="form-label">Unit of Measurement (UOM)</label>
          <input type="text" class="form-control dropdown-toggle w-100" name="uom" placeholder="Enter Unit of Measurement (UOM)"  aria-expanded="false" autocomplete="off" />
      </div>
    </div>
