        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('return'); ?>">
                  <div class="card-body">
                    <h4 class="card-title">Add Returns</h4>
<?php 
         ...
         <?php endif; ?>            
                  <div class="card-body border-top">
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="comname1" class="form-label">Returned Date</label>
                          <input type="text" class="form-control" name="returned_date" id="comname1" placeholder="Enter the Returned Date" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="returned_by"  id="email4" placeholder="Enter the Returned By" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="approved_by" id="conno2" placeholder="Enter the Approved By" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="return_qty" id="conno2" placeholder="Enter the Return Qty" />
                          </div>
                        </div>
                      </div>
