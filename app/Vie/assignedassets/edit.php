                     ...
                     <ul aria-expanded="false" class="collapse first-level">
                      ...
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('viewassignedassets'); ?>">
                         ...
                         <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('editassignedassets/'.base64_encode(base64_encode(base64_encode($assigned_assets_id)))); ?>">
                          <span class="icon-small"></span>Edit AssignedAssets
                        </a>
                      </li>
                    </ul>
                </li>
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Assigned Assets</h4>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('updateassignedassets'); ?>">
                  <div class="card-body">
                    <h4 class="card-title">Edit Assigned Assets</h4>
<?php 
...
<?php endif; ?>                    
                    ...
                    <div class="row">
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="hidden" value="<?= $assigned_assets_id ?>" name="assigned_assets_id">
                          <select name="assets_grn_no" class="form-control" id="assets_grn_no">
                             <option value="<?=$assets_grn_no;?>" selected><?=$assets_grn_no;?></option>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="title2" class="form-label">Asset Name</label>
                           <select name="assets_name" class="form-control" id="assets_name">
                               <option value="<?=$assets_name;?>" selected><?=$assets_name;?></option>
                              <option value="">Select Assets</option>
                              <?php foreach($assets_info as $info){
                              if($info['assets_name']!=''){
                              ?>
                              <option value="<?=$info['assets_name'];?>"><?=$info['assets_name'];?></option>
                              <?php } ?>
                              <?php } ?>
                          </select>
                        </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="comname1" class="form-label">Assets Brand</label>
                          <select name="assets_brand" class="form-control" id="assets_brand">
                            <option value="<?=$assets_brand;?>" selected><?=$assets_brand;?></option>
                              <option value="">Select Brand</option>
                              <?php foreach($assets_info as $info){ 
                                  if($info['assets_brand']!=''){
                                      
                              ?>
                              
                              <option value="<?=$info['assets_brand'];?>"><?=$info['assets_brand'];?></option>
                              <?php } ?>
                              <?php } ?>
                          </select>
                        </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Part Name</label>
                                <input type="text" class="form-control" id="assets_part_name" value="<?=$assets_part_name;?>"  placeholder="Enter the Part Name" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="assets_customer_name" value="<?=$assets_part_name;?>" id="assets_customer_name" placeholder="Enter the Customer Name" />
                          </div>
                        </div>
                      </div>
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Quantity Available</label>
                                <input type="text" class="form-control" id="assets_qty_avl" id="assets_qty_avl"  value="<?=$assets_qty_avl;?>" placeholder="Enter the Qty Available" />
                          </div>
                        </div>
                      </div>
                          <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="conno2" class="form-label">Employee Name</label>
                            <input type="text" class="form-control" name="assigned_assets_employee" id="assigned_assets_employee" value="<?=$assigned_assets_employee;?>" placeholder="Enter the Customer Name" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Qty Assigned</label>
                                <input type="text" class="form-control" name="assigned_assets_qty_assigned" value="<?=$assigned_assets_qty_assigned;?>" id="assigned_assets_qty_assigned" placeholder="Enter the Quantity" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Return Date</label>
                                <input type="date" class="form-control" id="assets_part_name" name="assigned_assets_retureddate" value="<?=$assigned_assets_retureddate;?>"  placeholder="Enter the Part Name" />
                          </div>
                        </div>
                      </div>
                       
                     
                     <?php $child=json_decode($assigned_assets_childpart);
                    
                     ?>
                       <div class="col-12">
                           <table class="table" id="autocomplete_table" style="border:0">
										<thead >
												<tr id="row_0">
													<th>
											Child Part List
											...
											<tbody >
											    ...
											    $i=1;
											    if(isset($child)){
											    foreach($child as $onebyone){?>
												<tr id="row_<?php echo $i ?>">
												
													<td>
                                                      <input  type="text" name="assigned_assets_childpart[]" class="form-control"  placeholder="Enter the Child Part" value="<?= $onebyone ?>" style="width:60%">
													</td>
													...
													<td>
													   <?php  if($i==1){ ?>
														...
														<?php }else{ ?>
															<button type="button" class="btn btn-danger" onclick="removeRow(<?php echo $i ?>)" style="border-radius:50px">
												...
												<tr>
													...
													<td>
                                                      <input  type="text" name="assigned_assets_childpart[]" class="form-control"  placeholder="Enter the Child Part" value="" style="width:60%">
													</td>
												</tr>
												<?php } ?>
                ...
                <?php
                 $base=base64_encode(base64_encode(base64_encode($assigned_assets_id))); 
                 ?>
   ...
   <a href="javascript:void(0)" id="btn-add-contact" class="btn btn-danger  float-right ms-6 px-4">
                   Delete
                  </a>
                        </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer  align-items-center">
                    <div class="d-flex gap-6 m-0">
                      <a href="<?= base_url('deleteassignedassets/'.$base); ?>"  id="btn-add" class="btn btn-danger justify-content-center">Yes</a>
...
function addRowContent()
{
	...
	html = '<tr id="row_'+rowcount+'"><td><input  type="text" name="assigned_assets_childpart[]" class="form-control"  placeholder="Enter the Child Part" style="width:60%"></td>';

	html +='<td><button type="button" class="btn btn-danger" onclick="removeRow('+rowcount+')" style="border-radius:50px"><i class="fa fa-minus-circle" style="font-size:20px"></i></button></td></tr>';
	rowcount++;
	return html;
}
