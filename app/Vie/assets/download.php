...
Hosur - 635109, Tamilnadu, India</p>
                ...
                <tr>
                    <td colspan="16" class="text-center" align="center"><u><h2>Assets Report</h2></u></td>
                </tr>
                <tr>
                    <th>S.No.</th>
                    <th>GRN No.</th>
            ...
            <tr>
                ...
                <td><?= $asset['assets_brand'] ?></td>
                <td><?= $asset['assets_vendor'] ?></td>
                <td><?= $asset['assets_qty_avl'] ?></td>
                <td><?= $asset['assets_rec_level'] ?></td>
                <td><?= $asset['assets_location'] ?></td>
                <td><?= $asset['assets_room']  ?></td>
            </tr>
        <?php $i++ ; endforeach; ?>
