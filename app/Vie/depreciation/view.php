...
if(isset($session->success)):?>
 ...
 <?php endif; ?>                   
                  ...
                  <form method="post"  action="<?= base_url('viewdepreciation'); ?>">
                  <div class="row"> 
                    
                  <div class="col-md-3">
                  <h4 class="card-title">View Depreciation Info</h4>
                  </div>
               <div class="col-md-2">
                ...
                <form method="post" action="<?= base_url('downloaddepreciation'); ?>"
                    ...
                    <tbody >
                      ...
                      <tr>
                        ...
                        <td><?= $data['rate_of_depreciation']; ?></td>
                          <?php if($assets_type=='DelAssets'){?>
                        <td><?= $data['depreciation_deleted_on']; ?></td>
                        <?php }else{ ?><td><?= $data['depreciation_created_on']; ?></td> <?php }?>
                        <td> <a href="<?= base_url('editdepreciation/'.$base); ?>" class="btn btn-info">
                          Update
                          </a>
                         </td>
                      </tr>
