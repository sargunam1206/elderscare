        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('depreciation'); ?>">
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="maintenence" id="fname3" placeholder="Enter the Maintenence" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="title2" class="form-label">Start Date</label>
                          <input type="date" class="form-control" name="start_date" id="title2" placeholder="Enter the Start Date" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="comname1" class="form-label">End Date</label>
                          <input type="date" class="form-control" name="end_date" id="comname1" placeholder="Enter the End Date" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="warrenty_reminder"  id="email4" placeholder="Enter the Warrenty Reminder" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="amc_level" id="conno2" placeholder="Enter the AMC Level" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="depreciation_method" id="conno2" placeholder="Enter the Depreciation method" />
                          </div>
                        </div>
                      </div>
                        <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="total_cost" id="conno2" placeholder="Enter the Total Cost" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="useful_life_in_years" id="conno2" placeholder="Enter the Useful Life in Years" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="salvage_value" id="conno2" placeholder="Enter the Salvage Value" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="rate_of_depreciation" id="conno2" placeholder="Enter the Rate of Depreciation" />
                          </div>
                        </div>
                      </div>
