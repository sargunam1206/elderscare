                  ...
                  <a class="sidebar-link has-arrow" href="<?= base_url(); ?>/public/dist/main/index3.html" aria-expanded="false">
                    ...
                    <li class="sidebar-item  ">
                      ...
                      <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('editdepreciation/'.base64_encode(base64_encode(base64_encode($alldata['depreciation_id'])))); ?>">
                          <span class="icon-small"></span>Edit Depreciation Info
                        </a>
                      </li>
                    </ul>
                    </li>
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Depreciation</h4>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <form  method="post" action="<?= base_url('updatedepreciation'); ?>">
                  <div class="card-body">
                    <h4 class="card-title">Add Assets Depreciation</h4>
<?php 
                    ...
                    <div class="row">
                       <div class="col-12">
                        <div class="mb-3">
                          ...
                          <input type="hidden" value="<?= $alldata['depreciation_id'];?>" name="depreciation_id" >
                          <select name="assets_grn_no" class="form-control" >
                         <?php if(($alldata['assets_grn_no']!='')){?><option value="<?= $alldata['assets_grn_no'];?>"><?= $alldata['assets_grn_no'];?></option><?php } ?>
                      ...
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="fname3" class="form-label">Maintenence</label>
                          <input type="text" class="form-control" name="maintenence" value="<?= $alldata['maintenence'];?>" id="fname3" placeholder="Enter the Maintenence" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="title2" class="form-label">Start Date</label>
                          <input type="date" class="form-control" name="start_date" value="<?= $alldata['start_date'];?>" id="title2" placeholder="Enter the Start Date" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="comname1" class="form-label">End Date</label>
                          <input type="date" class="form-control" name="end_date" value="<?= $alldata['end_date'];?>" id="comname1" placeholder="Enter the End Date" />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="email4" class="form-label">Warrenty Reminder</label>
                            <input type="text" class="form-control" name="warrenty_reminder" value="<?= $alldata['warrenty_reminder'];?>"  id="email4" placeholder="Enter the Warrenty Reminder" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                            <label for="conno2" class="form-label">AMC Level</label>
                            <input type="text" class="form-control" name="amc_level" value="<?= $alldata['amc_level'];?>" id="conno2" placeholder="Enter the AMC Level" />
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Depreciation method</label>
                                <input type="text" class="form-control" name="depreciation_method"   value="<?= $alldata['depreciation_method'];?>" id="conno2" placeholder="Enter the Depreciation method" />
                          </div>
                        </div>
                      </div>
                        <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Total Cost</label>
                                <input type="text" class="form-control" name="total_cost" value="<?= $alldata['total_cost'];?>" id="conno2" placeholder="Enter the Total Cost" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Useful Life in Years</label>
                                <input type="text" class="form-control" name="useful_life_in_years" value="<?= $alldata['useful_life_in_years'];?>" id="conno2" placeholder="Enter the Useful Life in Years" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Salvage Value</label>
                                <input type="text" class="form-control" name="salvage_value"  value="<?= $alldata['salvage_value'];?>" id="conno2" placeholder="Enter the Salvage Value" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-12">
                        <div class="mb-3">
                          <div class="mb-3">
                                <label for="conno2" class="form-label">Rate of Depreciation</label>
                                <input type="text" class="form-control" name="rate_of_depreciation" value="<?= $alldata['rate_of_depreciation'];?>"  id="conno2" placeholder="Enter the Rate of Depreciation" />
                          </div>
                        </div>
                      </div>
                     ...
                     <?php 
                          $base=base64_encode(base64_encode(base64_encode($alldata['depreciation_id'])));
                      ?>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer  align-items-center">
                    <div class="d-flex gap-6 m-0">
                       <a href="<?= base_url('deletedepreciation/'.$base); ?>"  id="btn-add" class="btn btn-danger justify-content-center">Yes</a>
