        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 gap-xl-5 gap-3 mb-lg-0">
                    ...
                    <li class="nav-item">    
                    <a class="nav-link fs-5 fw-semibold text-white <?= ($activePage == 'viewadvancebooking' || $activePage == 'advancebooking' || $activePage == 'editadvancebooking') ? 'active' : '' ?>" href="<?= base_url('viewadvancebooking'); ?>">Booking</a>
