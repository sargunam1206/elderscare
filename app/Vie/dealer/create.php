            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Dealer Name </h4>
    ...
    <div class="col-6">
      <div class="mb-3">
        <label for="dealer_name" class="form-label">Dealer Name</label>
          <input type="text" class="form-control dropdown-toggle w-100" name="dealer_name" placeholder="Enter Dealer Name"  aria-expanded="false" autocomplete="off" />
      </div>
    </div>
