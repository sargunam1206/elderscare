        ...
        <div class="col-md-12">
          <div class=" p-4 h-100 d-flex flex-column">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <h5 class="fs-5"><i class="bi bi-question-circle me-2 text-success"></i>Enquiries</h5>
              <div>
                ...
                <div class="col-md-2">
                  ...
                  <div class="dropdown">
                    <input type="text" class="form-control dropdown-toggle w-100"
                           name="roomTypeDisplay"
                           id="roomTypeFilterDisplay"
                           placeholder="Select Room Type"
                           data-bs-toggle="dropdown"
                           aria-expanded="false"
                           autocomplete="off"
                           readonly
                           value="<?= $filter_room_type ?: 'All' ?>" />

                    <!-- Hidden input to store the actual value -->
                    <input type="hidden" name="room_type" id="roomTypeFilter" value="<?= $filter_room_type ?: 'all' ?>">

                    <ul class="dropdown-menu p-2 w-100" aria-labelledby="roomTypeFilterDisplay"
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        setupRoomTypeDropdown();
           ...
           setupDropdown('roomTypeFilterDisplay', 'roomTypeFilter', 'roomTypeLists');
    });
