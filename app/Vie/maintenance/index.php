        ...
        <div class="col-md-12">
          <div class=" p-4 h-100 d-flex flex-column">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <h5 class="fs-5"><i class="bi bi-tools me-2 text-success"></i>Maintenance Requests</h5>
              <div>
    ...
    <div class="row g-3 align-items-end">
        ...
        <div class="col-md-2">
            ...
            <div class="dropdown">
                ...
                <!-- Hidden input to store the actual value -->
                <input type="hidden" name="type" id="typeFilter" value="<?= $filter_type ?: 'all' ?>">

                <ul class="dropdown-menu p-2 w-100" aria-labelledby="typeFilterdisplay"
                    style="max-height: 150px; overflow-y: auto;">
                ...
                <tbody>
                  <?php foreach($requests as $index => $request): ?>
                    <tr>
                      ...
                      <!-- <td>  <?= date("M d, Y", strtotime($request['created_on'])); ?></td> -->
...
<div class="col-md-6">
  ...
  <div class="dropdown">
    <input type="text" class="form-control dropdown-toggle w-100" name="typeDisplay"
      id="modalTypeFilterDisplay" placeholder="Select Type" data-bs-toggle="dropdown" aria-expanded="false"
      autocomplete="off" readonly required />
    <!-- Hidden input to store actual value -->
    <input type="hidden" name="type" id="modalTypeFilter" value="">
    <ul class="dropdown-menu p-2 w-100" aria-labelledby="modalTypeFilterDisplay" style="max-height: 150px; overflow-y: auto;">
      <div id="modalTypeLists" style="width: 100%;">
        <div class="dropdown-item" data-value="Cleaning">Cleaning</div>
        <div class="dropdown-item" data-value="Plumbing">Plumbing</div>
        <div class="dropdown-item" data-value="Electrical">Electrical</div>
        <div class="dropdown-item" data-value="Carpentry">Carpentry</div>
...
<div class="col-md-6">
  ...
  function editRequest(id) {
    ...
    document.getElementById('modalTypeFilter').value = data.type; // Changed
    ...
    document.getElementById('modalStatusFilterDisplay').value = data.status; // Changed
    document.getElementById('modalStatusFilter').value = data.status; // Changed
...
function removeFileItem(button) {
    ...
    setupFilterDropdown('statusFilterdisplay', 'statusFilter', 'statusLists');
    setupFilterDropdown('typeFilterdisplay', 'typeFilter', 'typeLists');
});
