  ...
  <div id="main-wrapper">
   <!-- Sidebar Start -->
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-md-0 card-title">Request Info</h4>
    ...
    <?php endif; ?>                   
                  ...
                  <form method="post"  action="<?= base_url('viewassetsvalue'); ?>">
                  <div class="row"> 
                    
                  <div class="col-md-3">
                  <h4 class="card-title">View Request Info</h4>
                  </div>
                 ...
                 <button class="btn btn-primary" type="submit" name="submit">submit</button>
                    ...
                    <!--<form method="post" action="<?= base_url('downloadassetsvalue'); ?>"
                    <div class=" col-md-2">
                  ...
                  <table id="form_inputs"  class="table table-striped w-100 table-bordered display text-nowrap align-middle ">
                    ...
                    <tbody >
                      ...
                      <td ><?= $data['id']; ?></td>
                        ...
                        <td> <a href="<?= base_url('editrequest/'.$data['id']); ?>" class="btn btn-info">
                          Update
                          </a>
                          </td>
                      </tr>
