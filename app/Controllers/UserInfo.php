         ...
         $this->noticesModel = new NoticeModel();
          $this->EnquiryModel = new EnquiryModel();
           $this->MaintenanceModel = new MaintenanceModel();
             ...
             $this->ServiceBookModel = new ServiceBookModel();
...
public function dashboard()
{
    ...
    $recentEnquiries = $this->EnquiryModel->getRecentEnquiries();

    // Get total enquiries count
    $totalEnquiries = $this->EnquiryModel->getTotalEnquiries();

    
    // Count of pending maintenance requests
    $pendingRequestscount = $this->MaintenanceModel->getPendingCount();

    $pendingRequests = $this->MaintenanceModel->getPendingRequests();

    $BookingsCount = $this->AdvanceBookingModel->countConfirmedList();

$recentBookings = $this->AdvanceBookingModel->getRecentBookings();
    ...
    error_reporting(E_ALL);
        ...
        //     return redirect()->to(base_url());
            ...
            //return redirect()->to('/');
       // }
        return view('layout/dashboard-Adm');
       
    }

     public function PointOfSale_dashboard()
    {
         ini_set('display_errors', '1');
    ini_set('display_startup_errors', '1');
    error_reporting(E_ALL);
    ...
    $yearly = $this->ChargesInfoModel->getCurrentYearPaidAmount();
        // $yearly = $this->ChargesInfoModel->getYearlyPaidAmount('2025');
          $serviceYearly = $this->ServiceBookModel->getCurrentYearServiceAmount();
        $data = [
    'yearlypaidamt' => $yearly['total_paid_amount'], // 👈 only pass the amount
    'yearlytransactions' => $yearly['total_transactions'],
     'service_total_amount' => $serviceYearly['total_service_amount'],
            'service_total_txn'    => $serviceYearly['total_transactions']
];
        ...
        //     return redirect()->to(base_url());
            ...
            //return redirect()->to('/');
       // }
        return view('layout/dashboard-PS',$data);
