...
class Uom extends BaseController
{
...

    {
      ...
      // Capture all form data
        ...
        //return redirect()->to(base_url('viewuom'));
         return redirect()->to(base_url('viewassettype').'?tab=uom');
    ...
    public function update($id)
    {
        ...
        return redirect()->to('viewassettype?tab=uom')->with('success', 'Updated successfully.');
    }
    ...
    public function delete($id)
    {
       ...
       return redirect()->to('viewassettype?tab=uom')->with('success', 'Deleted successfully.');
    }
