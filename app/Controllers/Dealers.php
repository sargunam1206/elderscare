...
class Dealers extends BaseController
{
...

    {
      ...
      // Capture all form data
        ...
        return redirect()->to(base_url('viewassettype').'?tab=dealers');
    ...
    public function update($id)
    {
        ...
        return redirect()->to('viewassettype?tab=dealers')->with('success', 'Updated successfully.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('viewassettype?tab=dealers')->with('success', 'Deleted successfully.');
    }
